...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <h3>优惠券管理</h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span>优惠券列表</span></a></li>
        <li><a href="index.php?act=coupon&op=bundling_quota"><span>赠送</span></a></li>
        <li><a href="index.php?act=coupon&op=setting"><span>设置</span></a></li>
      </ul>
    </div>
  </div>
