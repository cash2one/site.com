  ...
  <form id="article_form" method="post" name="articleForm" enctype="multipart/form-data">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
		...
		<tr>
          <td colspan="2" class="required">文章图标上传:</td>
        </tr>
        <tr class="noborder">
          <td colspan="3" id="divComUploadContainer"><input type="file" multiple="multiple" id="article_wap_icon" name="article_wap_icon" /></td>
        </tr>
        <tr>
