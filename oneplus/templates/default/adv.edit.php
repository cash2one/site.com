...
<!-- 价格 -->
      <tr class="noborder">
          <td colspan="2" class="required"><label ><?php echo $lang['adv_price'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="adv_price" id="adv_price " class="txt" value="<?php echo $v['adv_price']; ?>"></td>
          <td class="vatop tips"></td>
<!-- 价格end -->
<!-- 店铺id -->
      <tr class="noborder">
          <td colspan="2" class="required"><label >店铺id:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="store_id" id="store_id " class="txt" value="<?php echo $v['store_id']; ?>"></td>
          <td class="vatop tips"></td>
<!-- 店铺end -->
