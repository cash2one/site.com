  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" >背景图片:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform type-file-box">
              <input type="file" class="upload-activity-bg" id="activity_bg" name="activity_bg" size="30" hidefocus="true"  nc_type="upload_activity_bg" title="主体背景上传">
          </td>
...
<!-- 风格 -->
        ...
        <tr class="noborder" style="display:none;">
          ...
          <td class="vatop">请选择该活动所在页面的风格样式</td>
        </tr>
...
<!-- 模板 -->
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select id="activity_temp" name="activity_temp">
              <option value="default_temp">默认模板</option>
