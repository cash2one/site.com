    ...
    <table class="table tb-type2">
      <tbody>
       ...
       <!-- //zmr>v95-->
        ...
        <!-- 销售代表-->
         <tr>
          <td colspan="2" class="required"><label class="validation" for="salesperson">销售代表:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['store_array']['salesperson'];?>" id="salesperson" name="salesperson" class="txt"></td>
        </tr>
         <tr>
                        <td colspan="2" class="required"><?php echo $lang['store_pic']; ?>: </td>
                    </tr>
                    <tr class="noborder">
                          <td colspan="20">
                     
                            <input class="w200" type="file" name="store_pic">
                        </td>
                        <td class="vatop tips"><?php echo $lang['store_index_upload_tips'] . $lang['store_add_support_type']; ?>gif,jpg,png</td>
                    </tr>
