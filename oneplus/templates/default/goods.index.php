        ...
        <tr>
          ...
          <td><select name="is_recommend">
                  ...
                  <option value="0" <?php if($_GET['is_recommend'] === "0"){?>selected<?php }?>>否</option>
                        ...
                        <th><label>新品推荐</label></th>
          <td><select name="is_new">
                  <option value=""><?php echo $lang['nc_please_choose'];?>...</option>
                  <option value="1" <?php if($_GET['is_new'] === "1"){?>selected<?php }?>>是</option>
                  <option value="0" <?php if($_GET['is_new'] === "0"){?>selected<?php }?>>否</option>
              </select></td>
                        <th><label>尖货推荐</label></th>
          <td><select name="is_popular">
                  <option value=""><?php echo $lang['nc_please_choose'];?>...</option>
                  <option value="1" <?php if($_GET['is_popular'] === "1"){?>selected<?php }?>>是</option>
                  <option value="0" <?php if($_GET['is_popular'] === "0"){?>selected<?php }?>>否</option>
              </select></td>
               <th><label>欢乐送</label></th>
          <td><select name="is_happysend">
                  <option value=""><?php echo $lang['nc_please_choose'];?>...</option>
                  <option value="1" <?php if($_GET['is_happysend'] === "1"){?>selected<?php }?>>是</option>
                  <option value="0" <?php if($_GET['is_happysend'] === "0"){?>selected<?php }?>>否</option>
              </select></td>
        </tr>
        <tr>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="w72 align-center">商品推荐</th>
          <th class="w72 align-center">新品推荐</th>
          <th class="w72 align-center">尖货推荐</th>
          <th class="w72 align-center">欢乐送</th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="yes-onoff align-center"><a href="JavaScript:void(0);" class=" <?php echo $v['is_recommend']? 'enabled':'disabled'?>" ajax_branch='is_recommend'  nc_type="inline_edit" fieldname="is_recommend" fieldid="<?php echo $v['goods_commonid']?>" fieldvalue="<?php echo $v['is_recommend']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="yes-onoff align-center"><a href="JavaScript:void(0);" class=" <?php echo $v['is_new']? 'enabled':'disabled'?>" ajax_branch='is_new'  nc_type="inline_edit" fieldname="is_new" fieldid="<?php echo $v['goods_commonid']?>" fieldvalue="<?php echo $v['is_new']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="yes-onoff align-center"><a href="JavaScript:void(0);" class=" <?php echo $v['is_popular']? 'enabled':'disabled'?>" ajax_branch='is_popular'  nc_type="inline_edit" fieldname="is_popular" fieldid="<?php echo $v['goods_commonid']?>" fieldvalue="<?php echo $v['is_popular']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a></td>  
           <td class="yes-onoff align-center"><a href="JavaScript:void(0);" class=" <?php echo $v['is_happysend']? 'enabled':'disabled'?>" ajax_branch='is_happysend'  nc_type="inline_edit" fieldname="is_happysend" fieldid="<?php echo $v['goods_commonid']?>" fieldvalue="<?php echo $v['is_happysend']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a></td>    
          ...
          <td class="align-center"><a href="index.php?act=goods&op=goods_edit&goods_commonid=<?php echo $v['goods_commonid'];?>" >编辑</a></td>
