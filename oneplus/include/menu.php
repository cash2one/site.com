		...
		'left' =>array(
			...
			2 => array(
				...
				'list' => array(
					...
					array('args'=>'inspiration,goods_inspiration,goods',	'text'=>'瞬间审核'),
				)
			),
			3 => array(
				'nav' => 'store',
			...
			6 => array(
				...
				'list' => array(
                    ...
                    array('args'=>'news_class,news_class,website',			'text'=>'新闻分类'),
                    array('args'=>'news,news,website',						'text'=>'新闻管理'),
			...
			7 => array(
				...
				'list' => array(
					...
					array('args'=>'list,coupon,operation',			    'text'=>'优惠券管理'),
					...
					array('args'=>'index,mall_consult,operation',               'text'=>'平台客服'),
                                        ...
                                        array('args'=>'index,umeng_push,operation',                   'text'=>'友盟推送'),
                                        array('args'=>'index,designers_live,operation',                   'text'=>'设计师直播')
	...
	$arr['left'][] = array(
				...
				'list' => array(
                    ...
                    array('args'=>'flist,mb_feedback,mobile',					'text'=>$lang['nc_mobile_feedback']),
                     array('args'=>'flist,wap_message,mobile',					'text'=>'留言回复'),
	...
	$arr['left'][] = array(
				...
				'list' => array(
					...
					7 => array('args'=>'adv_manage,microshop,microshop','text'=>$lang['nc_microshop_adv_manage']),
                                        8 => array('args'=>'mirco_like,microshop,microshop','text'=>'瞬间点赞')
				)
			);
}
if(C('cms_isuse') !== null){
