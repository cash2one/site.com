...
class wxpay
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            ...
            'appSecret' => 'a8d6a3d92f41fd9a8b5843f6c065d5fd',
            'partnerId' => '1281572601',
            'apiKey' => 'HwHzO8PXFcapsgXNE1laJceOWRehCnfw',

            'notifyUrl' => MOBILE_SITE_URL . '/api/payment/wxpay/notify_url.php',
            'finishedUrl' => WAP_SITE_URL . '/tmpl/member/order_list.html?data-state',
            'undoneUrl' => WAP_SITE_URL . '/tmpl/member/order_list.html?data-state=state_new',
