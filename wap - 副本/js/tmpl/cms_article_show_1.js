...
$(function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $(".store_description").html(result.datas.like_count+" fans");
            ...
            //微信分享配置
            $("#share").attr("title1", result.datas.store_name);
            $("#share").attr("imgUrl", result.datas.store_avatar);
            $("#share").attr("desc", result.datas.store_description);
            $("#share").attr("link", '/tmpl/store.html?store_id='+result.datas.store_id);
            
            if (result.datas.store_state == 1) {
            ...
            $("#store_notcollect").click(function () {
                ...
                if (t) {
                    ...
                    $.ajax({
                        ...
                        data : {"key" : t, "store_id" : result.datas.store_id},
                        dataType : "json"                        
