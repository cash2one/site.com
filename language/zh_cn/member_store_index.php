...
$lang['store_setting_label_tip']			= '此处理店铺页logo；<br/><span style="color:orange;">建议使用宽300像素*高300像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_avatar']		= '店铺头像';
$lang['store_setting_sign_tip']				= '此处为店铺方形头像；<br/><span style="color:orange;">建议使用宽300像素*高300像素内的方型图片；点击下方"提交"按钮后生效。</span>';
$lang['store_setting_change_banner']		= 'PC海报';
$lang['store_setting_banner_tip']			= '此处为店铺页banner导航；<br/><span style="color:orange;">建议使用宽960像素*高402像素的图片；点击下方"提交"按钮后生效。</span>';
