...
class loginControl extends BaseHomeControl
{
    ...
    public function indexOp()
    {
        ...
        if ($result !== false) {
            ...
            if($memory == 1) {
                ...
                $model_member->createCookie($member_info);
			...
			//$register_lang = Language::getLangContent();
            ...
            if ($_pic[0] != '') {
                ...
                Tpl::output('lpic', UPLOAD_SITE_URL . '/' . ATTACH_LOGIN . '/' . rand(1, 3) . '.jpg');
    ...
    public function usersaveOp()
    {
		...
		//update by lizh 15:23 2016/7/12 取消手机验证码验证
