...
<div class="cLineB">
  ...
  <div class="pageNavigator left"> <a href="<?php echo U('Adcms/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"> <img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a></div>
  <div class="pageNavigator left"><a href="<?php echo U('Adcms/flash',array('token'=>$token));?>" title="幻灯片管理" class="btnGrayS vm bigbtn"> <img src="<?php echo RES;?>/images/product/add.png" width="16">幻灯片管理</a> </div>
  <div class="cLine">

            <?php if($usertplid == 0): ?><div style="float:right;line-height:30px;">
            ...
            <?php else: ?>
              ...
              <!--/*<div class="vm02">
                    ...
                    <a href='<?php echo U("Nr/add");?>' title='内容分享'>内容分享</a>　
            <div class="clr"></div>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <THEAD>
                ...
                <TR valign="top">
					...
					<TH  style="text-align:center" width="20%">封面图片</TH>

					<TH style="text-align:center" width="20%">标题</TH>

					 <TH style="text-align:center"  width="10%">所属类别</TH>

                    <TH style="text-align:center"  width="20%">添加时间</TH>
                     <TH style="text-align:center"  width="10%">剩余费用</TH>
                    <TH style="text-align:center"  width="5%">点击量</TH>
              ...
              <TBODY>
				...
				<form action="<?php echo U("Nr/edit");?>" method="post" id="sortform">

				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>

                  <td style="text-align:center"> <img src="<?php echo ($vo["pic"]); ?>" style="width:100px"></td>

                  <td style="text-align:center"><?php echo ($vo["title"]); ?></td>

                    <td style="text-align:center"><?php switch($vo['type']): case "1": ?>今日头条<?php break;?>
<?php case "2": ?>生活百科<?php break;?>
<?php case "3": ?>情感人生<?php break;?>
<?php case "4": ?>搞笑轻松<?php break;?>
<?php case "5": ?>职场智慧<?php break;?>
<?php case "6": ?>旅游星座<?php break; endswitch;?></td>

                 <td style="text-align:center"><?php echo (date('Y-m-d H-i-s',$vo["time"])); ?></td>
                   <td style="text-align:center"><?php echo ($vo["adrmb"]); ?></td>
                   <td style="text-align:center"><?php echo ($vo["click"]); ?></td>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Adcms/set',array('id'=>$vo['id'],'token'=>$vo['token']));?>" title="编辑图文自定义回复">编辑</a>

				   <a href="<?php echo U('Adcms/del',array('id'=>$vo['id'],'token'=>$vo['token']));?>">删除</a></td>
