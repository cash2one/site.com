...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content">
<div class="cLineB">
<h4 class="left">同城AA</h4>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Aaactivity/set',array('token'=>$token));?>" title="添加活动" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加活动</a></div>
...
<td>
	<?php if($item["is_audit"] == '1'): ?>已审核
	<?php else: ?>	
		<B>未审核</B><?php endif; ?>
</td> 
<td>
<?php if($item["is_user"] == '1'): ?><b>用户发起</b>
<br/><?php echo ($item["usename"]); endif; ?>
</td>
<td class="norightborder">
	<a href="<?php echo U('Aaactivity/rank',array('id'=>$item['id'],'token'=>$token));?>">同城AA报名列表</a>
	<a href="<?php echo U('Aaactivity/set',array('id'=>$item['id'],'token'=>$token));?>">修改</a>
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Aaactivity/del',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
