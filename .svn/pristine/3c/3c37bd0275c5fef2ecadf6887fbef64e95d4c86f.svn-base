 ...
 */	
function comment_like(obj,comment_id,state){ 
...
/**
 * 删除瞬间
 * add by lizh 15:42 2016/8/30
 */
function moment_del(obj,id) {
    ...
    $.ajax({
        ...
        type : 'POST',
        url : ApiUrl1 + '/index.php?act=micro_sent&op=personal_del',
        data : {'personal_id':id,'key':key},
        dataType : 'json',

        success : function(data) {

            if(data.datas.status == 'success') {
