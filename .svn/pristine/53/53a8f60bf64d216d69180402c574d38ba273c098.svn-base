...
<!--活动开始-->
<div class="cLineB">
    <h4>砍价广告活动设置</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
</div>
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="keyword" value="<?php if($set["keyword"] == ''): ?>砍价传媒<?php else: echo ($set["keyword"]); endif; ?>" name="keyword" style="width:400px" ><br />
  	<span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。
  </TD>
  <TD rowspan="4" valign="top">
	  <div style="margin-left:20px">
		<img id="pic1_src" src="<?php if($set['reply_pic'] == ''): echo ($staticPath); ?>/tpl/static/Adkanjia/images/bq.png<?php else: echo ($set["reply_pic"]); endif; ?>" width="373px" >
		<br />
		<input class="px"  name="reply_pic" value="<?php if($set['reply_pic'] == ''): echo ($staticPath); ?>/tpl/static/Adkanjia/images/bq.png<?php else: echo ($set["reply_pic"]); endif; ?>" id="pic1" style="width:363px;"  />
		<br />
...
<TR>
  ...
  <TD>
	<input type="input" class="px" id="title" value="<?php if($set["title"] == ''): ?>砍价传媒，增加曝光率<?php else: echo ($set["title"]); endif; ?>" name="title" style="width:400px" />
  	<br />
  	请不要多于50字!
  </TD>
</tr>
<TR>
  ...
  <TD>
    <input class="px"  name="top_pic" value="<?php if($set['top_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Adkanjia/images/bg.jpg<?php else: echo ($set["top_pic"]); endif; ?>" id="pic2" style="width:310px;"  />
...
<tr>
  	<th valign="top"><span class="red">*</span>整体背景颜色：</th>
  	<td>
  		<input class="px" type="input" name="bgcolor" value="<?php if($set['bgcolor'] == ''): ?>#cf2929<?php else: echo ($set["bgcolor"]); endif; ?>"> 如：#cf2929
  	</td>
</tr>
<TR>
...
<tr>
  	...
  	<td>
  		<input class="px" type="input" name="price" value="<?php echo ($set["price"]); ?>"> 元 商品原价
  	</td>
</tr>

<tr>
  	<th valign="top"><span class="red">*</span>成功价格：</th>
  	<td>
  		<input class="px" type="input" name="okprice" value="<?php echo ($set["okprice"]); ?>"> 元 砍到多少元算成功？比如：0
  	</td>
</tr>

<tr>
  	<th valign="top"><span class="red">*</span>商品详情图：</th>
  	<td>
    <input class="px"  name="xq_pic" value="<?php if($set['xq_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Adkanjia/css/img/main.png<?php else: echo ($set["xq_pic"]); endif; ?>" id="pic4" style="width:310px;"  />
    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic4',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic4')">预览</a>
  	</td>
</tr>
...
<tr>
  	<th valign="top"><span class="red">*</span>底部广告连接：</th>
  	<td>
  		<input class="px" type="input" name="adurl" value="<?php echo ($set["adurl"]); ?>" style="width:400px;"> 页面底部的广告连接，包含http://
  	</td>
</tr>

<tr>
  	<th valign="top"><span class="red">*</span>底部广告图片：</th>
  	<td>
    <input class="px"  name="ad_pic" value="<?php if($set['ad_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Adkanjia/images/600.gif<?php else: echo ($set["ad_pic"]); endif; ?>" id="pic3" style="width:310px;"  />
    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic3',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic3')">预览</a>
  	</td>
</tr>
 ...
 <TR>
  <th valign="top"><span class="red"></span>需要粉丝详细信息：</th>
  <td>
