  ...
  <form method="post" name="settingForm" id="settingForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required">壹积金</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="onempf_isuse_1" class="cb-enable <?php if($output['list_setting']['onempf_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['open'];?>"><span><?php echo $lang['open'];?></span></label>
            <label for="onempf_isuse_0" class="cb-disable <?php if($output['list_setting']['onempf_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['close'];?>"><span><?php echo $lang['close'];?></span></label>
            <input id="onempf_isuse_1" name="onempf_isuse" <?php if($output['list_setting']['onempf_isuse'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="onempf_isuse_0" name="onempf_isuse" <?php if($output['list_setting']['onempf_isuse'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
          <td class="vatop tips">壹积金启用后，会员分享注册之后会得到一块大洋，被分享者两个月内如果有购买东西，可获得他的2%的分佣，分享的商品也有同样的效果。</td>
        </tr>
          ...
          <td class="" colspan="2"><table class="table tb-type2 nomargin">
              ...
              <tbody>
                ...
                <tr class="hover">
                 ...
                 <tr class="hover">
                  <td>邀请注册</td>
                  <td><input id="onempf_invite" name="onempf_invite" value="<?php echo $output['list_setting']['onempf_invite'];?>" class="txt" type="text" style="width:60px;">邀请非会员注册时给邀请人的现金数</td>
                </tr>
		<tr class="hover">
                  <td>返利比例</td>
                  <td><input id="points_rebate" name="points_rebate" value="<?php echo $output['list_setting']['points_rebate'];?>" class="txt" type="text" style="width:35px;">% &nbsp;&nbsp;&nbsp;被邀请会员购买商品时给邀请人返的积分数(例如设为5%，被邀请人购买100元商品，返给邀请人5积分)</td>
                </tr>
                <tr class="hover">
                  <td>返利比例</td>
                  <td><input id="onempf_rebate" name="onempf_rebate" value="<?php echo $output['list_setting']['onempf_rebate'];?>" class="txt" type="text" style="width:35px;">% &nbsp;&nbsp;&nbsp;被邀请会员购买商品时给邀请人返的钱财(例如设为5%，被邀请人购买100元商品，返给邀请人5块钱)</td>
                </tr>
              </tbody>
            </table>
