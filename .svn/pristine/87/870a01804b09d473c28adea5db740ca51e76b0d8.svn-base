...
<div class="cLineB">
  ...
  <div class="pageNavigator left"> <a href="<?php echo U('Adcms/flash_add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"> <img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a></div>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <THEAD>
                ...
                <TR valign="top">
					...
					<TH style="text-align:center" width="20%">描述语</TH>

					 <TH style="text-align:center"  width="10%">链接</TH>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Adcms/flash_set',array('id'=>$vo['id'],'token'=>$vo['token']));?>" title="编辑">编辑</a>

				   <a href="<?php echo U('Adcms/flash_del',array('id'=>$vo['id'],'token'=>$vo['token']));?>">删除</a></td>
