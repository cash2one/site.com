...
<form class="configform" method="post" action="<?php echo U('FrontPage/addconfigure',array('token'=>$this->token));?>">
<div class="content">
<div class="cLineB"><h4>配置信息</h4><a href="<?php echo U('FrontPage/listconfigure',array('token'=>$this->token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回配置列表</a></div>
<div class="msgWrap bgfc">
<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
<tbody>
<tr>
  <th valign="top"><span class="red">*</span>请求接口的key：</th>
  <td><input type="input" class="px" id="apikey" value="<?php echo ($set["apikey"]); ?>" name="apikey" style="width:400px"></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>请求接口的Secret Key：</th>
  <td><input type="input" class="px" id="secretkey" value="<?php echo ($set["secretkey"]); ?>" name="secretkey" style="width:400px"></td> 	
</tr>
<tr>
<th>&nbsp;</th>
