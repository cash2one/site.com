...
<div class="home-standard-layout wrapper style-<?php echo $output['style_name'];?>">
  <div class="left-sidebar">
    <div class="title">
      	...
      	<?php }else { ?>
      	<div class="pic-type"><img src="<?php echo $output['code_tit']['code_info']['pic'];?>"/></div>
      	<?php } ?>
    </div>
    <div class="left-ads">
      	...
      	<img src="<?php  echo $output['code_act']['code_info']['pic'];?>" alt="<?php echo $output['code_act']['code_info']['title']; ?>">
      	</a>
      	<?php } ?>
    </div>
      ...
      <ul>
                  ...
                  <?php foreach ($output['code_adv']['code_info'] as $key => $val) { ?>
                      ...
                      <li><a href="<?php echo $val['pic_url'];?>" title="<?php echo $val['pic_name'];?>" target="_blank">
                        <img src="<?php echo $val['pic_img'];?>" alt="<?php echo $val['pic_name'];?>"/></a>
                      	</li>
                      <?php } ?>
                  <?php } ?>
                  <?php } ?>
