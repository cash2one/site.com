...
DROP TABLE IF EXISTS `wantease_activity`;
CREATE TABLE `wantease_activity` (
...
DROP TABLE IF EXISTS `wantease_activity_detail`;
CREATE TABLE `wantease_activity_detail` (
...
DROP TABLE IF EXISTS `wantease_address`;
CREATE TABLE `wantease_address` (
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='买家地址信息表';

DROP TABLE IF EXISTS `wantease_admin`;
CREATE TABLE `wantease_admin` (
...
DROP TABLE IF EXISTS `wantease_admin_log`;
CREATE TABLE `wantease_admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1847 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志';

DROP TABLE IF EXISTS `wantease_adv`;
CREATE TABLE `wantease_adv` (
  ...
  PRIMARY KEY (`adv_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1090 DEFAULT CHARSET=utf8 COMMENT='广告表';

DROP TABLE IF EXISTS `wantease_adv_click`;
CREATE TABLE `wantease_adv_click` (
...
DROP TABLE IF EXISTS `wantease_adv_position`;
CREATE TABLE `wantease_adv_position` (
  ...
  PRIMARY KEY (`ap_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1263 DEFAULT CHARSET=utf8 COMMENT='广告位表';

DROP TABLE IF EXISTS `wantease_album_class`;
CREATE TABLE `wantease_album_class` (
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='相册表';

DROP TABLE IF EXISTS `wantease_album_pic`;
CREATE TABLE `wantease_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7636 DEFAULT CHARSET=utf8 COMMENT='相册图片表';

DROP TABLE IF EXISTS `wantease_area`;
CREATE TABLE `wantease_area` (
...
DROP TABLE IF EXISTS `wantease_arrival_notice`;
CREATE TABLE `wantease_arrival_notice` (
...
DROP TABLE IF EXISTS `wantease_article`;
CREATE TABLE `wantease_article` (
...
DROP TABLE IF EXISTS `wantease_article_class`;
CREATE TABLE `wantease_article_class` (
...
DROP TABLE IF EXISTS `wantease_attribute`;
CREATE TABLE `wantease_attribute` (
...
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8 COMMENT='商品属性表';

DROP TABLE IF EXISTS `wantease_attribute_value`;
CREATE TABLE `wantease_attribute_value` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3200 DEFAULT CHARSET=utf8 COMMENT='商品属性值表';

DROP TABLE IF EXISTS `wantease_brand`;
CREATE TABLE `wantease_brand` (
  `brand_id` mediumint(11) NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `brand_name` varchar(100) DEFAULT NULL COMMENT '品牌名称',
  `brand_country` varchar(100) DEFAULT NULL COMMENT '品牌国家',
  ...
  `brand_advertisement1` varchar(255) DEFAULT NULL COMMENT '大广告',
  `brand_introduction` varchar(255) NOT NULL COMMENT '品牌介绍',
  `brand_poster` varchar(100) DEFAULT NULL COMMENT '品牌海报',
  `brand_illustration_pic` varchar(100) DEFAULT NULL COMMENT '插图',
  ...
  `brand_advertisement2` varchar(255) DEFAULT NULL COMMENT '广告',
  PRIMARY KEY (`brand_id`)
) ENGINE=InnoDB AUTO_INCREMENT=381 DEFAULT CHARSET=utf8 COMMENT='品牌表';

DROP TABLE IF EXISTS `wantease_cart`;
CREATE TABLE `wantease_cart` (
...
) ENGINE=InnoDB AUTO_INCREMENT=216 DEFAULT CHARSET=utf8 COMMENT='购物车数据表';

DROP TABLE IF EXISTS `wantease_chat_log`;
CREATE TABLE `wantease_chat_log` (
...
DROP TABLE IF EXISTS `wantease_chat_msg`;
CREATE TABLE `wantease_chat_msg` (
  `m_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `f_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `f_name` varchar(50) NOT NULL COMMENT '会员名',
  `f_ip` varchar(15) NOT NULL COMMENT '发自IP',
...
DROP TABLE IF EXISTS `wantease_circle`;
CREATE TABLE `wantease_circle` (
...
DROP TABLE IF EXISTS `wantease_circle_affix`;
CREATE TABLE `wantease_circle_affix` (
...
DROP TABLE IF EXISTS `wantease_circle_class`;
CREATE TABLE `wantease_circle_class` (
...
DROP TABLE IF EXISTS `wantease_circle_explog`;
CREATE TABLE `wantease_circle_explog` (
...
DROP TABLE IF EXISTS `wantease_circle_expmember`;
CREATE TABLE `wantease_circle_expmember` (
...
DROP TABLE IF EXISTS `wantease_circle_exptheme`;
CREATE TABLE `wantease_circle_exptheme` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `wantease_circle_fs`;
CREATE TABLE `wantease_circle_fs` (
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
...
DROP TABLE IF EXISTS `wantease_circle_inform`;
CREATE TABLE `wantease_circle_inform` (
...
DROP TABLE IF EXISTS `wantease_circle_like`;
CREATE TABLE `wantease_circle_like` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主题赞表';

DROP TABLE IF EXISTS `wantease_circle_mapply`;
CREATE TABLE `wantease_circle_mapply` (
...
DROP TABLE IF EXISTS `wantease_circle_member`;
CREATE TABLE `wantease_circle_member` (
  `member_id` int(11) unsigned NOT NULL COMMENT '会员id',
  `circle_id` int(11) unsigned NOT NULL COMMENT '圈子id',
  `circle_name` varchar(12) NOT NULL COMMENT '圈子名称',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
...
DROP TABLE IF EXISTS `wantease_circle_ml`;
CREATE TABLE `wantease_circle_ml` (
  `circle_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '圈子id',
...
DROP TABLE IF EXISTS `wantease_circle_mldefault`;
CREATE TABLE `wantease_circle_mldefault` (
...
DROP TABLE IF EXISTS `wantease_circle_mlref`;
CREATE TABLE `wantease_circle_mlref` (
...
DROP TABLE IF EXISTS `wantease_circle_recycle`;
CREATE TABLE `wantease_circle_recycle` (
...
DROP TABLE IF EXISTS `wantease_circle_thclass`;
CREATE TABLE `wantease_circle_thclass` (
...
DROP TABLE IF EXISTS `wantease_circle_theme`;
CREATE TABLE `wantease_circle_theme` (
...
DROP TABLE IF EXISTS `wantease_circle_thg`;
CREATE TABLE `wantease_circle_thg` (
...
DROP TABLE IF EXISTS `wantease_circle_thpoll`;
CREATE TABLE `wantease_circle_thpoll` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
...
DROP TABLE IF EXISTS `wantease_circle_thpolloption`;
CREATE TABLE `wantease_circle_thpolloption` (
...
DROP TABLE IF EXISTS `wantease_circle_thpollvoter`;
CREATE TABLE `wantease_circle_thpollvoter` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '话题id',
  `member_id` int(11) unsigned NOT NULL COMMENT '成员id',
  `member_name` varchar(50) NOT NULL COMMENT '成员名称',
...
DROP TABLE IF EXISTS `wantease_circle_threply`;
CREATE TABLE `wantease_circle_threply` (
  `theme_id` int(11) unsigned NOT NULL COMMENT '主题id',
...
DROP TABLE IF EXISTS `wantease_cms_article`;
CREATE TABLE `wantease_cms_article` (
  ...
  PRIMARY KEY (`article_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='CMS文章表';

DROP TABLE IF EXISTS `wantease_cms_article_attitude`;
CREATE TABLE `wantease_cms_article_attitude` (
...
DROP TABLE IF EXISTS `wantease_cms_article_class`;
CREATE TABLE `wantease_cms_article_class` (
...
DROP TABLE IF EXISTS `wantease_cms_comment`;
CREATE TABLE `wantease_cms_comment` (
...
DROP TABLE IF EXISTS `wantease_cms_comment_up`;
CREATE TABLE `wantease_cms_comment_up` (
  ...
  PRIMARY KEY (`up_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='CMS评论顶表';

DROP TABLE IF EXISTS `wantease_cms_index_module`;
CREATE TABLE `wantease_cms_index_module` (
...
DROP TABLE IF EXISTS `wantease_cms_module`;
CREATE TABLE `wantease_cms_module` (
...
DROP TABLE IF EXISTS `wantease_cms_module_assembly`;
CREATE TABLE `wantease_cms_module_assembly` (
...
DROP TABLE IF EXISTS `wantease_cms_module_frame`;
CREATE TABLE `wantease_cms_module_frame` (
...
DROP TABLE IF EXISTS `wantease_cms_navigation`;
CREATE TABLE `wantease_cms_navigation` (
...
DROP TABLE IF EXISTS `wantease_cms_picture`;
CREATE TABLE `wantease_cms_picture` (
...
DROP TABLE IF EXISTS `wantease_cms_picture_class`;
CREATE TABLE `wantease_cms_picture_class` (
  `class_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(1) unsigned NOT NULL DEFAULT '255' COMMENT '排序',
  PRIMARY KEY (`class_id`)
...
DROP TABLE IF EXISTS `wantease_cms_picture_image`;
CREATE TABLE `wantease_cms_picture_image` (
...
DROP TABLE IF EXISTS `wantease_cms_special`;
CREATE TABLE `wantease_cms_special` (
...
DROP TABLE IF EXISTS `wantease_cms_tag`;
CREATE TABLE `wantease_cms_tag` (
...
DROP TABLE IF EXISTS `wantease_cms_tag_relation`;
CREATE TABLE `wantease_cms_tag_relation` (
...
DROP TABLE IF EXISTS `wantease_complain`;
CREATE TABLE `wantease_complain` (
...
DROP TABLE IF EXISTS `wantease_complain_subject`;
CREATE TABLE `wantease_complain_subject` (
...
DROP TABLE IF EXISTS `wantease_complain_talk`;
CREATE TABLE `wantease_complain_talk` (
...
DROP TABLE IF EXISTS `wantease_consult`;
CREATE TABLE `wantease_consult` (
...
DROP TABLE IF EXISTS `wantease_consult_type`;
CREATE TABLE `wantease_consult_type` (
...
DROP TABLE IF EXISTS `wantease_cron`;
CREATE TABLE `wantease_cron` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wantease_daddress`;
CREATE TABLE `wantease_daddress` (
  `address_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址ID',
...
DROP TABLE IF EXISTS `wantease_delivery_order`;
CREATE TABLE `wantease_delivery_order` (
  `order_id` int(11) NOT NULL COMMENT '订单ID',
...
DROP TABLE IF EXISTS `wantease_delivery_point`;
CREATE TABLE `wantease_delivery_point` (
...
DROP TABLE IF EXISTS `wantease_document`;
CREATE TABLE `wantease_document` (
...
DROP TABLE IF EXISTS `wantease_evaluate_goods`;
CREATE TABLE `wantease_evaluate_goods` (
...
DROP TABLE IF EXISTS `wantease_evaluate_store`;
CREATE TABLE `wantease_evaluate_store` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='店铺评分表';

DROP TABLE IF EXISTS `wantease_exppoints_log`;
CREATE TABLE `wantease_exppoints_log` (
  ...
  PRIMARY KEY (`exp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='经验值日志表';

DROP TABLE IF EXISTS `wantease_express`;
CREATE TABLE `wantease_express` (
...
DROP TABLE IF EXISTS `wantease_favorites`;
CREATE TABLE `wantease_favorites` (
  `member_id` int(10) unsigned NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `wantease_flea`;
CREATE TABLE `wantease_flea` (
...
DROP TABLE IF EXISTS `wantease_flea_area`;
CREATE TABLE `wantease_flea_area` (
...
DROP TABLE IF EXISTS `wantease_flea_class`;
CREATE TABLE `wantease_flea_class` (
...
DROP TABLE IF EXISTS `wantease_flea_class_index`;
CREATE TABLE `wantease_flea_class_index` (
...
DROP TABLE IF EXISTS `wantease_flea_consult`;
CREATE TABLE `wantease_flea_consult` (
  `consult_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '咨询编号',
...
DROP TABLE IF EXISTS `wantease_flea_favorites`;
CREATE TABLE `wantease_flea_favorites` (
  `member_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `fav_id` int(10) unsigned NOT NULL COMMENT '收藏ID',
  `fav_type` varchar(20) NOT NULL COMMENT '收藏类型',
...
DROP TABLE IF EXISTS `wantease_flea_upload`;
CREATE TABLE `wantease_flea_upload` (
...
DROP TABLE IF EXISTS `wantease_flowstat`;
CREATE TABLE `wantease_flowstat` (
...
DROP TABLE IF EXISTS `wantease_flowstat_1`;
CREATE TABLE `wantease_flowstat_1` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
DROP TABLE IF EXISTS `wantease_flowstat_2`;
CREATE TABLE `wantease_flowstat_2` (
  `stattime` int(11) unsigned NOT NULL COMMENT '访问日期',
  `clicknum` int(11) unsigned NOT NULL COMMENT '访问量',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `type` varchar(10) NOT NULL COMMENT '类型',
...
DROP TABLE IF EXISTS `wantease_gadmin`;
CREATE TABLE `wantease_gadmin` (
...
DROP TABLE IF EXISTS `wantease_goods`;
CREATE TABLE `wantease_goods` (
  ...
  PRIMARY KEY (`goods_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101608 DEFAULT CHARSET=utf8 COMMENT='商品表';

DROP TABLE IF EXISTS `wantease_goods_attr_index`;
CREATE TABLE `wantease_goods_attr_index` (
  `goods_id` int(10) unsigned NOT NULL COMMENT '商品id',
  `goods_commonid` int(10) unsigned NOT NULL COMMENT '商品公共表id',
  `gc_id` int(10) unsigned NOT NULL COMMENT '商品分类id',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
...
DROP TABLE IF EXISTS `wantease_goods_browse`;
CREATE TABLE `wantease_goods_browse` (
  `goods_id` int(11) NOT NULL COMMENT '商品ID',
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `wantease_goods_class`;
CREATE TABLE `wantease_goods_class` (
  `gc_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `gc_name` varchar(100) NOT NULL COMMENT '分类名称',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
...
) ENGINE=InnoDB AUTO_INCREMENT=1374 DEFAULT CHARSET=utf8 COMMENT='商品分类表';

DROP TABLE IF EXISTS `wantease_goods_class_staple`;
CREATE TABLE `wantease_goods_class_staple` (
...
) ENGINE=InnoDB AUTO_INCREMENT=228 DEFAULT CHARSET=utf8 COMMENT='店铺常用分类表';

DROP TABLE IF EXISTS `wantease_goods_class_tag`;
CREATE TABLE `wantease_goods_class_tag` (
...
DROP TABLE IF EXISTS `wantease_goods_combo`;
CREATE TABLE `wantease_goods_combo` (
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='商品推荐组合表';

DROP TABLE IF EXISTS `wantease_goods_common`;
CREATE TABLE `wantease_goods_common` (
...
) ENGINE=InnoDB AUTO_INCREMENT=100857 DEFAULT CHARSET=utf8 COMMENT='商品公共内容表';

DROP TABLE IF EXISTS `wantease_goods_fcode`;
CREATE TABLE `wantease_goods_fcode` (
  ...
  PRIMARY KEY (`fc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='商品F码';

DROP TABLE IF EXISTS `wantease_goods_gift`;
CREATE TABLE `wantease_goods_gift` (
...
DROP TABLE IF EXISTS `wantease_goods_images`;
CREATE TABLE `wantease_goods_images` (
...
) ENGINE=InnoDB AUTO_INCREMENT=5802 DEFAULT CHARSET=utf8 COMMENT='商品图片';

DROP TABLE IF EXISTS `wantease_groupbuy`;
CREATE TABLE `wantease_groupbuy` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='团购商品表';

DROP TABLE IF EXISTS `wantease_groupbuy_class`;
CREATE TABLE `wantease_groupbuy_class` (
...
DROP TABLE IF EXISTS `wantease_groupbuy_price_range`;
CREATE TABLE `wantease_groupbuy_price_range` (
...
DROP TABLE IF EXISTS `wantease_groupbuy_quota`;
CREATE TABLE `wantease_groupbuy_quota` (
...
DROP TABLE IF EXISTS `wantease_help`;
CREATE TABLE `wantease_help` (
...
DROP TABLE IF EXISTS `wantease_help_type`;
CREATE TABLE `wantease_help_type` (
...
DROP TABLE IF EXISTS `wantease_inform`;
CREATE TABLE `wantease_inform` (
...
DROP TABLE IF EXISTS `wantease_inform_subject`;
CREATE TABLE `wantease_inform_subject` (
...
DROP TABLE IF EXISTS `wantease_inform_subject_type`;
CREATE TABLE `wantease_inform_subject_type` (
...
DROP TABLE IF EXISTS `wantease_invoice`;
CREATE TABLE `wantease_invoice` (
...
DROP TABLE IF EXISTS `wantease_link`;
CREATE TABLE `wantease_link` (
...
DROP TABLE IF EXISTS `wantease_live_area`;
CREATE TABLE `wantease_live_area` (
...
) ENGINE=InnoDB AUTO_INCREMENT=382 DEFAULT CHARSET=utf8 COMMENT='线下区域表';

DROP TABLE IF EXISTS `wantease_live_class`;
CREATE TABLE `wantease_live_class` (
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='线下分类表';

DROP TABLE IF EXISTS `wantease_live_groupbuy`;
CREATE TABLE `wantease_live_groupbuy` (
  ...
  PRIMARY KEY (`groupbuy_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='线下团购表';

DROP TABLE IF EXISTS `wantease_live_order`;
CREATE TABLE `wantease_live_order` (
...
DROP TABLE IF EXISTS `wantease_live_order_pwd`;
CREATE TABLE `wantease_live_order_pwd` (
...
DROP TABLE IF EXISTS `wantease_lock`;
CREATE TABLE `wantease_lock` (
...
DROP TABLE IF EXISTS `wantease_mail_cron`;
CREATE TABLE `wantease_mail_cron` (
...
DROP TABLE IF EXISTS `wantease_mail_msg_temlates`;
CREATE TABLE `wantease_mail_msg_temlates` (
...
DROP TABLE IF EXISTS `wantease_mall_consult`;
CREATE TABLE `wantease_mall_consult` (
...
DROP TABLE IF EXISTS `wantease_mall_consult_type`;
CREATE TABLE `wantease_mall_consult_type` (
...
DROP TABLE IF EXISTS `wantease_mb_category`;
CREATE TABLE `wantease_mb_category` (
...
DROP TABLE IF EXISTS `wantease_mb_feedback`;
CREATE TABLE `wantease_mb_feedback` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `wantease_mb_payment`;
CREATE TABLE `wantease_mb_payment` (
...
DROP TABLE IF EXISTS `wantease_mb_special`;
CREATE TABLE `wantease_mb_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_desc` varchar(20) NOT NULL COMMENT '专题描述',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='手机专题表';

DROP TABLE IF EXISTS `wantease_mb_special_item`;
CREATE TABLE `wantease_mb_special_item` (
  ...
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='手机专题项目表';

DROP TABLE IF EXISTS `wantease_mb_user_token`;
CREATE TABLE `wantease_mb_user_token` (
...
) ENGINE=InnoDB AUTO_INCREMENT=546 DEFAULT CHARSET=utf8 COMMENT='移动端登录令牌表';

DROP TABLE IF EXISTS `wantease_member`;
CREATE TABLE `wantease_member` (
...
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='会员表';

DROP TABLE IF EXISTS `wantease_member_common`;
CREATE TABLE `wantease_member_common` (
  `member_id` int(11) NOT NULL COMMENT '会员ID',
...
DROP TABLE IF EXISTS `wantease_member_msg_setting`;
CREATE TABLE `wantease_member_msg_setting` (
...
DROP TABLE IF EXISTS `wantease_member_msg_tpl`;
CREATE TABLE `wantease_member_msg_tpl` (
  `mmt_code` varchar(50) NOT NULL COMMENT '用户消息模板编号',
...
DROP TABLE IF EXISTS `wantease_message`;
CREATE TABLE `wantease_message` (
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='短消息';

DROP TABLE IF EXISTS `wantease_micro_adv`;
CREATE TABLE `wantease_micro_adv` (
...
DROP TABLE IF EXISTS `wantease_micro_comment`;
CREATE TABLE `wantease_micro_comment` (
  `comment_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论编号',
  `comment_type` tinyint(1) NOT NULL COMMENT '评论类型编号',
  `comment_object_id` int(10) unsigned NOT NULL COMMENT '推荐商品编号',
...
DROP TABLE IF EXISTS `wantease_micro_goods`;
CREATE TABLE `wantease_micro_goods` (
...
DROP TABLE IF EXISTS `wantease_micro_goods_class`;
CREATE TABLE `wantease_micro_goods_class` (
...
DROP TABLE IF EXISTS `wantease_micro_goods_relation`;
CREATE TABLE `wantease_micro_goods_relation` (
  `relation_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '关系编号',
...
DROP TABLE IF EXISTS `wantease_micro_like`;
CREATE TABLE `wantease_micro_like` (
...
DROP TABLE IF EXISTS `wantease_micro_member_info`;
CREATE TABLE `wantease_micro_member_info` (
...
DROP TABLE IF EXISTS `wantease_micro_personal`;
CREATE TABLE `wantease_micro_personal` (
...
DROP TABLE IF EXISTS `wantease_micro_personal_class`;
CREATE TABLE `wantease_micro_personal_class` (
  `class_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类编号 ',
  `class_name` varchar(50) NOT NULL COMMENT '分类名称',
  `class_sort` tinyint(4) unsigned NOT NULL COMMENT '排序',
  `class_image` varchar(100) NOT NULL DEFAULT '' COMMENT '分类图片',
...
DROP TABLE IF EXISTS `wantease_micro_store`;
CREATE TABLE `wantease_micro_store` (
...
DROP TABLE IF EXISTS `wantease_navigation`;
CREATE TABLE `wantease_navigation` (
  ...
  PRIMARY KEY (`nav_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='页面导航表';

DROP TABLE IF EXISTS `wantease_offpay_area`;
CREATE TABLE `wantease_offpay_area` (
...
DROP TABLE IF EXISTS `wantease_order`;
CREATE TABLE `wantease_order` (
...
DROP TABLE IF EXISTS `wantease_order_bill`;
CREATE TABLE `wantease_order_bill` (
  ...
  PRIMARY KEY (`ob_no`)
) ENGINE=InnoDB AUTO_INCREMENT=20151016 DEFAULT CHARSET=utf8 COMMENT='结算表';

DROP TABLE IF EXISTS `wantease_order_common`;
CREATE TABLE `wantease_order_common` (
  `order_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '订单索引id',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺ID',
  ...
  `dlyo_pickup_code` varchar(4) DEFAULT NULL COMMENT '提货码',
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表';

DROP TABLE IF EXISTS `wantease_order_goods`;
CREATE TABLE `wantease_order_goods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='订单商品表';

DROP TABLE IF EXISTS `wantease_order_log`;
CREATE TABLE `wantease_order_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='订单处理历史表';

DROP TABLE IF EXISTS `wantease_order_pay`;
CREATE TABLE `wantease_order_pay` (
...
DROP TABLE IF EXISTS `wantease_order_statis`;
CREATE TABLE `wantease_order_statis` (
...
DROP TABLE IF EXISTS `wantease_p_booth_goods`;
CREATE TABLE `wantease_p_booth_goods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='展位商品表';

DROP TABLE IF EXISTS `wantease_p_booth_quota`;
CREATE TABLE `wantease_p_booth_quota` (
...
DROP TABLE IF EXISTS `wantease_p_bundling`;
CREATE TABLE `wantease_p_bundling` (
...
DROP TABLE IF EXISTS `wantease_p_bundling_goods`;
CREATE TABLE `wantease_p_bundling_goods` (
...
DROP TABLE IF EXISTS `wantease_p_bundling_quota`;
CREATE TABLE `wantease_p_bundling_quota` (
...
DROP TABLE IF EXISTS `wantease_p_mansong`;
CREATE TABLE `wantease_p_mansong` (
...
DROP TABLE IF EXISTS `wantease_p_mansong_quota`;
CREATE TABLE `wantease_p_mansong_quota` (
...
DROP TABLE IF EXISTS `wantease_p_mansong_rule`;
CREATE TABLE `wantease_p_mansong_rule` (
...
DROP TABLE IF EXISTS `wantease_p_xianshi`;
CREATE TABLE `wantease_p_xianshi` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='限时折扣活动表';

DROP TABLE IF EXISTS `wantease_p_xianshi_goods`;
CREATE TABLE `wantease_p_xianshi_goods` (
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='限时折扣商品表';

DROP TABLE IF EXISTS `wantease_p_xianshi_quota`;
CREATE TABLE `wantease_p_xianshi_quota` (
...
DROP TABLE IF EXISTS `wantease_payment`;
CREATE TABLE `wantease_payment` (
  `payment_id` tinyint(1) unsigned NOT NULL COMMENT '支付索引id',
  `payment_code` char(10) NOT NULL COMMENT '支付代码名称',
  `payment_name` char(10) NOT NULL COMMENT '支付名称',
...
DROP TABLE IF EXISTS `wantease_pd_cash`;
CREATE TABLE `wantease_pd_cash` (
...
DROP TABLE IF EXISTS `wantease_pd_log`;
CREATE TABLE `wantease_pd_log` (
  ...
  PRIMARY KEY (`lg_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='预存款变更日志表';

DROP TABLE IF EXISTS `wantease_pd_recharge`;
CREATE TABLE `wantease_pd_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='预存款充值表';

DROP TABLE IF EXISTS `wantease_points_cart`;
CREATE TABLE `wantease_points_cart` (
...
DROP TABLE IF EXISTS `wantease_points_goods`;
CREATE TABLE `wantease_points_goods` (
...
DROP TABLE IF EXISTS `wantease_points_log`;
CREATE TABLE `wantease_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';

DROP TABLE IF EXISTS `wantease_points_order`;
CREATE TABLE `wantease_points_order` (
...
DROP TABLE IF EXISTS `wantease_points_orderaddress`;
CREATE TABLE `wantease_points_orderaddress` (
...
DROP TABLE IF EXISTS `wantease_points_ordergoods`;
CREATE TABLE `wantease_points_ordergoods` (
...
DROP TABLE IF EXISTS `wantease_rcb_log`;
CREATE TABLE `wantease_rcb_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='充值卡余额变更日志表';

DROP TABLE IF EXISTS `wantease_rec_position`;
CREATE TABLE `wantease_rec_position` (
  `rec_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `pic_type` enum('1','2','0') NOT NULL DEFAULT '1' COMMENT '0文字1本地图片2远程',
  `title` varchar(200) NOT NULL DEFAULT '' COMMENT '标题',
  `content` text NOT NULL COMMENT '序列化推荐位内容',
  PRIMARY KEY (`rec_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='推荐位';

DROP TABLE IF EXISTS `wantease_rechargecard`;
CREATE TABLE `wantease_rechargecard` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='平台充值卡';

DROP TABLE IF EXISTS `wantease_refund_reason`;
CREATE TABLE `wantease_refund_reason` (
...
DROP TABLE IF EXISTS `wantease_refund_return`;
CREATE TABLE `wantease_refund_return` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='退款退货表';

DROP TABLE IF EXISTS `wantease_seller`;
CREATE TABLE `wantease_seller` (
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='卖家用户表';

DROP TABLE IF EXISTS `wantease_seller_group`;
CREATE TABLE `wantease_seller_group` (
...
DROP TABLE IF EXISTS `wantease_seller_log`;
CREATE TABLE `wantease_seller_log` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2094 DEFAULT CHARSET=utf8 COMMENT='卖家日志表';

DROP TABLE IF EXISTS `wantease_seo`;
CREATE TABLE `wantease_seo` (
...
DROP TABLE IF EXISTS `wantease_setting`;
CREATE TABLE `wantease_setting` (
  `name` varchar(50) NOT NULL COMMENT '名称',
  `value` text COMMENT '值',
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统设置表';

DROP TABLE IF EXISTS `wantease_sns_albumclass`;
CREATE TABLE `wantease_sns_albumclass` (
  ...
  PRIMARY KEY (`ac_id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='相册表';

DROP TABLE IF EXISTS `wantease_sns_albumpic`;
CREATE TABLE `wantease_sns_albumpic` (
...
DROP TABLE IF EXISTS `wantease_sns_binding`;
CREATE TABLE `wantease_sns_binding` (
...
DROP TABLE IF EXISTS `wantease_sns_comment`;
CREATE TABLE `wantease_sns_comment` (
...
DROP TABLE IF EXISTS `wantease_sns_friend`;
CREATE TABLE `wantease_sns_friend` (
...
DROP TABLE IF EXISTS `wantease_sns_goods`;
CREATE TABLE `wantease_sns_goods` (
...
DROP TABLE IF EXISTS `wantease_sns_membertag`;
CREATE TABLE `wantease_sns_membertag` (
...
DROP TABLE IF EXISTS `wantease_sns_mtagmember`;
CREATE TABLE `wantease_sns_mtagmember` (
...
DROP TABLE IF EXISTS `wantease_sns_setting`;
CREATE TABLE `wantease_sns_setting` (
  `member_id` int(11) NOT NULL COMMENT '会员id',
  `setting_skin` varchar(50) DEFAULT NULL COMMENT '皮肤',
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人中心设置表';

DROP TABLE IF EXISTS `wantease_sns_sharegoods`;
CREATE TABLE `wantease_sns_sharegoods` (
...
DROP TABLE IF EXISTS `wantease_sns_sharestore`;
CREATE TABLE `wantease_sns_sharestore` (
  `share_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
...
DROP TABLE IF EXISTS `wantease_sns_tracelog`;
CREATE TABLE `wantease_sns_tracelog` (
...
DROP TABLE IF EXISTS `wantease_sns_visitor`;
CREATE TABLE `wantease_sns_visitor` (
...
DROP TABLE IF EXISTS `wantease_spec`;
CREATE TABLE `wantease_spec` (
...
DROP TABLE IF EXISTS `wantease_spec_value`;
CREATE TABLE `wantease_spec_value` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1500 DEFAULT CHARSET=utf8 COMMENT='商品规格值表';

DROP TABLE IF EXISTS `wantease_stat_member`;
CREATE TABLE `wantease_stat_member` (
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COMMENT='会员相关数据统计';

DROP TABLE IF EXISTS `wantease_stat_order`;
CREATE TABLE `wantease_stat_order` (
  `order_id` int(11) NOT NULL COMMENT '订单id',
  `order_sn` bigint(20) unsigned NOT NULL COMMENT '订单编号',
...
DROP TABLE IF EXISTS `wantease_stat_ordergoods`;
CREATE TABLE `wantease_stat_ordergoods` (
...
DROP TABLE IF EXISTS `wantease_store`;
CREATE TABLE `wantease_store` (
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='店铺数据表';

DROP TABLE IF EXISTS `wantease_store_bind_class`;
CREATE TABLE `wantease_store_bind_class` (
  ...
  PRIMARY KEY (`bid`),
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='店铺可发布商品类目表';

DROP TABLE IF EXISTS `wantease_store_class`;
CREATE TABLE `wantease_store_class` (
...
DROP TABLE IF EXISTS `wantease_store_cost`;
CREATE TABLE `wantease_store_cost` (
  ...
  PRIMARY KEY (`cost_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='店铺费用表';

DROP TABLE IF EXISTS `wantease_store_decoration`;
CREATE TABLE `wantease_store_decoration` (
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='店铺装修表';

DROP TABLE IF EXISTS `wantease_store_decoration_album`;
CREATE TABLE `wantease_store_decoration_album` (
  `image_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片编号',
...
DROP TABLE IF EXISTS `wantease_store_decoration_block`;
CREATE TABLE `wantease_store_decoration_block` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='店铺装修块表';

DROP TABLE IF EXISTS `wantease_store_extend`;
CREATE TABLE `wantease_store_extend` (
...
DROP TABLE IF EXISTS `wantease_store_goods_class`;
CREATE TABLE `wantease_store_goods_class` (
  ...
  KEY `store_id` (`store_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='店铺商品分类表';

DROP TABLE IF EXISTS `wantease_store_grade`;
CREATE TABLE `wantease_store_grade` (
...
DROP TABLE IF EXISTS `wantease_store_joinin`;
CREATE TABLE `wantease_store_joinin` (
  `member_id` int(10) unsigned NOT NULL COMMENT '用户编号',
...
DROP TABLE IF EXISTS `wantease_store_msg`;
CREATE TABLE `wantease_store_msg` (
  ...
  PRIMARY KEY (`sm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='店铺消息表';

DROP TABLE IF EXISTS `wantease_store_msg_read`;
CREATE TABLE `wantease_store_msg_read` (
...
DROP TABLE IF EXISTS `wantease_store_msg_setting`;
CREATE TABLE `wantease_store_msg_setting` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
  `store_id` int(10) unsigned NOT NULL COMMENT '店铺id',
...
DROP TABLE IF EXISTS `wantease_store_msg_tpl`;
CREATE TABLE `wantease_store_msg_tpl` (
  `smt_code` varchar(100) NOT NULL COMMENT '模板编码',
...
DROP TABLE IF EXISTS `wantease_store_navigation`;
CREATE TABLE `wantease_store_navigation` (
  ...
  PRIMARY KEY (`sn_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='卖家店铺导航信息表';

DROP TABLE IF EXISTS `wantease_store_plate`;
CREATE TABLE `wantease_store_plate` (
...
DROP TABLE IF EXISTS `wantease_store_reopen`;
CREATE TABLE `wantease_store_reopen` (
...
DROP TABLE IF EXISTS `wantease_store_sns_comment`;
CREATE TABLE `wantease_store_sns_comment` (
...
DROP TABLE IF EXISTS `wantease_store_sns_setting`;
CREATE TABLE `wantease_store_sns_setting` (
...
DROP TABLE IF EXISTS `wantease_store_sns_tracelog`;
CREATE TABLE `wantease_store_sns_tracelog` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='店铺动态表';

DROP TABLE IF EXISTS `wantease_store_watermark`;
CREATE TABLE `wantease_store_watermark` (
...
DROP TABLE IF EXISTS `wantease_store_waybill`;
CREATE TABLE `wantease_store_waybill` (
...
DROP TABLE IF EXISTS `wantease_transport`;
CREATE TABLE `wantease_transport` (
...
DROP TABLE IF EXISTS `wantease_transport_extend`;
CREATE TABLE `wantease_transport_extend` (
...
DROP TABLE IF EXISTS `wantease_type`;
CREATE TABLE `wantease_type` (
  `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '类型id',
  `type_name` varchar(100) NOT NULL COMMENT '类型名称',
  ...
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='商品类型表';

DROP TABLE IF EXISTS `wantease_type_brand`;
CREATE TABLE `wantease_type_brand` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `brand_id` int(10) unsigned NOT NULL COMMENT '品牌id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与品牌对应表';

DROP TABLE IF EXISTS `wantease_type_spec`;
CREATE TABLE `wantease_type_spec` (
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `sp_id` int(10) unsigned NOT NULL COMMENT '规格id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与规格对应表';

DROP TABLE IF EXISTS `wantease_upload`;
CREATE TABLE `wantease_upload` (
  `upload_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `file_name` varchar(100) DEFAULT NULL COMMENT '文件名',
  `file_thumb` varchar(100) DEFAULT NULL COMMENT '缩微图片',
  `file_size` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文件大小',
  ...
  `item_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '信息ID',
  PRIMARY KEY (`upload_id`)
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8 COMMENT='上传文件表';

DROP TABLE IF EXISTS `wantease_voucher`;
CREATE TABLE `wantease_voucher` (
...
DROP TABLE IF EXISTS `wantease_voucher_price`;
CREATE TABLE `wantease_voucher_price` (
...
DROP TABLE IF EXISTS `wantease_voucher_quota`;
CREATE TABLE `wantease_voucher_quota` (
...
DROP TABLE IF EXISTS `wantease_voucher_template`;
CREATE TABLE `wantease_voucher_template` (
...
DROP TABLE IF EXISTS `wantease_vr_groupbuy_area`;
CREATE TABLE `wantease_vr_groupbuy_area` (
...
DROP TABLE IF EXISTS `wantease_vr_groupbuy_class`;
CREATE TABLE `wantease_vr_groupbuy_class` (
...
DROP TABLE IF EXISTS `wantease_vr_order`;
CREATE TABLE `wantease_vr_order` (
...
DROP TABLE IF EXISTS `wantease_vr_order_bill`;
CREATE TABLE `wantease_vr_order_bill` (
...
DROP TABLE IF EXISTS `wantease_vr_order_code`;
CREATE TABLE `wantease_vr_order_code` (
...
DROP TABLE IF EXISTS `wantease_vr_order_statis`;
CREATE TABLE `wantease_vr_order_statis` (
  `os_month` mediumint(9) unsigned NOT NULL DEFAULT '0' COMMENT '统计编号(年月)',
  `os_year` smallint(6) DEFAULT '0' COMMENT '年',
  `os_start_date` int(11) NOT NULL COMMENT '开始日期',
  `os_end_date` int(11) NOT NULL COMMENT '结束日期',
...
DROP TABLE IF EXISTS `wantease_vr_refund`;
CREATE TABLE `wantease_vr_refund` (
  `refund_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
...
DROP TABLE IF EXISTS `wantease_waybill`;
CREATE TABLE `wantease_waybill` (
...
DROP TABLE IF EXISTS `wantease_web`;
CREATE TABLE `wantease_web` (
...
DROP TABLE IF EXISTS `wantease_web_code`;
CREATE TABLE `wantease_web_code` (
...
DROP TABLE IF EXISTS `wantease_web_special`;
CREATE TABLE `wantease_web_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_title` varchar(50) NOT NULL COMMENT '专题标题',
  `special_margin_top` int(10) DEFAULT '0' COMMENT '正文距顶部距离',
  `special_background` varchar(255) DEFAULT NULL COMMENT '专题背景',
  ...
  `special_repeat` varchar(10) NOT NULL DEFAULT 'no-repeat' COMMENT '背景重复方式',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城专题表';
