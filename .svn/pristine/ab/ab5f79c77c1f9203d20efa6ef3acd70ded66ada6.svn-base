...
<head lang="en">
	...
	<link href="<?php echo CMS_TEMPLATES_URL;?>/css/shuodongye.css" rel="stylesheet" type="text/css">
	<link href="<?php echo CMS_TEMPLATES_URL;?>/css/shuodongye2.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery-1.11.3.js"></script>
	...
	<!-- update by lizh 10:26 2016/7/1-->
	<link rel="stylesheet" href="<?php echo C('shop_site_url'); ?>/templates/default/newcss/dengluye.css"/>
	<link href="<?php echo C('shop_site_url'); ?>/templates/default/newcss/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<link href="<?php echo C('shop_site_url'); ?>/templates/default/css/base.css" rel="stylesheet" type="text/css">
	<link href="<?php echo C('shop_site_url'); ?>/templates/default/css/home_login.css" rel="stylesheet" type="text/css">
	<!-- S 新头部的CSS-->
	<link rel="stylesheet" href="<?php echo C('shop_site_url'); ?>/templates/default/newcss/header.css"/>
	<!-- E 新头部的CSS-->
	
	<script src="<?php echo C('shop_site_url'); ?>/templates/default/newjs/jquery.js"></script>
    <script src="<?php echo C('shop_site_url'); ?>/templates/default/newjs/jquery.validation.min.js"></script>
	<script>
		...
		var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL; ?>';
		var SHOP_TEMPLATES_URL = <?php echo "'".C('shop_site_url')."'"; ?> + '/templates/default';
		//console.log(SITEURL);
	</script>
	<!-- end -->
...
<div>
 <div class="nav">
         <div class="nav-left">
            ...
            <img src="<?php C('shop_site_url'); ?>/templates/default/newimg/indexlogo.png" alt=""/>
			</a>
            ...
            <div class="nav-ll">
             ...
             <span class="gouwuche">
				<a href="index.php?act=cart">
                 <img src="<?php C('shop_site_url'); ?>/templates/default/newimg/gouwuche.png" alt=""/>
        ...
        <div class="shousuo">
			<form method="get" action="<?php echo SHOP_SITE_URL; ?>">
					<span class="search">
						...
						<i>
							<img src="<?php C('shop_site_url'); ?>/templates/default/newimg/indexsuch.png" alt=""/>
