...
<div class="cLineB">
  ...
  <div class="pageNavigator left"> <a href="<?php echo U('Hongbaoqiye/zzs_add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"> <img src="<?php echo RES;?>/images/product/add.png" width="16">添加</a></div>
...
<td style="text-align:center"><?php echo ($i); ?></td>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Hongbaoqiye/zzs_edit',array('id'=>$vo['id'],'token'=>$vo['token']));?>" title="编辑">编辑</a>

				   <a href="<?php echo U('Hongbaoqiye/zzs_del',array('id'=>$vo['id'],'token'=>$vo['token']));?>">删除</a></td>
