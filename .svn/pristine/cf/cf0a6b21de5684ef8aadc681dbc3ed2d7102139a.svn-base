...
<div class="page">
  ...
  <form id="brand_form" method="post" name="form1" enctype="multipart/form-data" action="index.php?act=brand&op=brand_edit">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['brand_array']['buyer_name']?>" name="buyer_name" id="buyer_yuju" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
                <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['brand_array']['buyer_yuju']?>" name="buyer_yuju" id="buyer_yuju" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['brand_index_class_tips'];?></td>
                ...
                <tr class="noborder">
                    <td class="vatop rowform"><span class="type-file-show"><a class="nyroModal" rel="gal" ><img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL; ?>/images/preview.png"></a>
                            ...
                            <input type='button' name='button' id='button2' class='type-file-button' />
                        </span></td>
         ...
         <tr class="noborder">
          <td class="vatop rowform"><textarea name="brand_introduction" rows="6" class="tarea"  ><?php echo $output['brand_array']['brand_introduction'];?></textarea></td>
        </tr>
        <tr>
...
$(function(){
	...
	$('input[class="type-file-file"]').change(uploadChange);
         regionInit("region");
	$('input[nc_type="change_brand_banner"]').change(function(){
		var src = getFullPath($(this)[0]);
		$('img[nc_type="brand_banner"]').attr('src', src);
	});
