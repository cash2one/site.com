		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					...
					<?php echo ($pc_site); ?> &nbsp;&nbsp;
					<?php
 if ($_SERVER['HTTP_HOST']=='demo.pigcms.cn'){ echo '<span style="color:red">演示站自动分配域名，购买后可以指定任意域名</span>'; echo '<span style="display:none"><input type="text" name="pc_site" id="pc_site" value="'.$pc_site.'" class="px" style="width:350px;height:24px;"/>&nbsp;&nbsp;&nbsp;请填写域名，不支持二级目录，不包含（http://）或（/）</span>'; }else { echo '<span><input type="text" name="pc_site" id="pc_site" value="'.$pc_site.'" class="px" style="width:350px;height:24px;"/>&nbsp;&nbsp;&nbsp;请填写域名，不支持二级目录，不包含（http://）或（/）</span>'; } ?>
					</td>
