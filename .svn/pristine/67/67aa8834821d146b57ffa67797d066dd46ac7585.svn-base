...
<tr>
  ...
  <?php if($set["reply_pic"] != ''): ?><img class="thumb_img" id="picurl_src1" src="<?php echo ($set["reply_pic"]); ?>" style="max-height:100px;max-width: 200px;">
	<?php else: ?>
	<img class="thumb_img" id="picurl_src1" src="<?php echo ($staticPath); ?>/tpl/static/hongbao/images/weixinheti.png" style="max-height:100px;max-width: 200px;"><?php endif; ?>
  <input type="text" name="reply_pic" value='<?php if($set['reply_pic'] != ''): echo ($set["reply_pic"]); else: echo ($staticPath); ?>/tpl/static/hongbao/images/weixinheti.png<?php endif; ?>' id="pic1" class="px" style="width:200px;" >
