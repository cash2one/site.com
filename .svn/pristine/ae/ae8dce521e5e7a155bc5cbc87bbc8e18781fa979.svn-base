...
<div class="content">
	...
	<div class="cLineB">
		 ...
		 <h4>赞助商添加</h4>  <a href="<?php echo U('Adcms/flash',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> 
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tbody>
                  <tr>
						 ...
						 <TH valign="top"><label for="pic">赞助商logo：</label></TH>
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="url" placeholder=" 请输入链接" value="<?php echo ($info["url"]); ?>" class="px" style="width:400px;" />
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="name" placeholder=" 请输入描述语" value="<?php echo ($info["name"]); ?>" class="px" style="width:400px;" />
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="info" placeholder=" 请输入简" value="<?php echo ($info["info"]); ?>" class="px" style="width:400px;" />
