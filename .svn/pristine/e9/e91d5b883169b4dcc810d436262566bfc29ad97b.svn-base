...
.pagination li a:hover span, .pagination li a:active span { color: #FFF; text-decoration: none !important; background-color: #ff5400; border-color: #CA3300; position: relative; z-index: 9; cursor:pointer; }
