...
<span class="tit">会员登录</span>
    ...
    <div class="user" nctype="a-barLoginBox"> <a href="javascript:void(0);" >
          <div><img src="<?php echo UPLOAD_SITE_URL; ?>/index/right02.png"/></div>
          <!--  <div class="avatar"><img src="<?php echo UPLOAD_SITE_URL; ?>/index/right02.png"/></div> -->
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <?php }?><span style="margin-left:10px;"><a href="index.php?act=invite" style="color:red;">分享可免单</a></span>
    </div>
