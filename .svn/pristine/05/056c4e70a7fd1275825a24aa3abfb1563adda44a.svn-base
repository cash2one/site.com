...
<form class="shakeform" method="post" action="<?php echo U('ShakeLottery/AddShakeLottery');?>">
<div class="content">
<div class="cLineB">
...
<tr>
  ...
  <td><input type="input" class="px" id="action_name" value="<?php echo ($set["action_name"]); ?>" name="action_name" style="width:400px"></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>关键词：</th>
  <td><input type="input" class="px" id="keyword" value="<?php if($set["keyword"] != ''): echo ($set["keyword"]); else: ?>抽奖<?php endif; ?>" name="keyword" style="width:400px"></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>回复标题：</th>
  <td><input type="input" class="px" id="reply_title" value="<?php echo ($set["reply_title"]); ?>" name="reply_title" style="width:400px"></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>回复内容：</th>
  <td><textarea type="input" class="px" id="reply_content" name="reply_content" style="width: 560px; height: 100px;"><?php echo ($set["reply_content"]); ?></textarea></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>回复图片：</th>
  <td>  <?php if($set["reply_pic"] != ''): ?><img class="thumb_img" id="pic0_src" src="<?php echo ($set["reply_pic"]); ?>" style="max-height:100px;max-width: 200px;">
	<?php else: ?>
	<img class="thumb_img" id="pic0_src" src="<?php echo ($staticPath); ?>/tpl/static/shakelottery/images/shakelottery.jpg" style="max-height:100px;max-width: 200px;"><?php endif; ?>
  <input type="text" name="reply_pic" value='<?php if($set['reply_pic'] != ''): echo ($set["reply_pic"]); else: echo ($staticPath); ?>/tpl/static/shakelottery/images/shakelottery.jpg<?php endif; ?>' id="pic0" class="px" style="width:200px;" >
  <a href="###" onclick="upyunPicUpload('pic0',365,158,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic0')">预览</a>   &nbsp; 建议图片尺寸365*158，图片大小不超过300K</td> 	
</tr>
<tr>
<th width="120">活动简介：</th>
<td><textarea class="px" id="action_desc" name="action_desc" style="width: 560px; height: 200px;"><?php echo ($set['action_desc']); ?></textarea></td>
</tr>
<tr>
...
<tr>
  ...
  <td><input type="input" class="px" id="custom_sharetitle" value="<?php echo ($set["custom_sharetitle"]); ?>" name="custom_sharetitle" style="width:470px"><br /> 	
...
<tr>
  ...
  <td><input type="input" class="px" id="custom_sharedsc" value="<?php echo ($set["custom_sharedsc"]); ?>" name="custom_sharedsc" style="width: 470px;"><br />
...
<td><input type="text" name="follow_btn_msg" value="<?php if($set['follow_btn_msg'] != ''): echo ($set["follow_btn_msg"]); else: ?>立即关注<?php endif; ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
<th width="120">快捷关注链接：</th>
<td><input type="text" name="custom_follow_url" value="<?php echo ($set["custom_follow_url"]); ?>" class="px" style="width:550px;"><br>(通过配置图文消息获取快捷关注链接,该快捷链接是指在手机端弹出关注弹框时点击的链接)<br /><a href="<?php echo U('Voteimg/set_reply');?>" target="_blank" style="color:red;">如何配置图文消息来获取链接地址</a>&nbsp;&nbsp; <input type="hidden" value="<?php echo ($staticPath); ?>/tpl/static/voteimg/img/weixin_7.jpg" id="follow_url_example"><a onclick="viewImg('follow_url_example')" href="###" style="color:#1FC419;">配置后的效果图范例</a></td>
</tr>
<tr>
<th width="120">需要粉丝手机号提示语：</th>
<td><input type="text" name="register_msg" value="<?php if($set["register_msg"] != ''): echo ($set["register_msg"]); else: ?>您好，需要您先填写个人信息才能参加活动<?php endif; ?>" class="px" style="width:550px;"></td>
</tr>
<tr>
<th>活动时间：</th>
<td><input type="input" class="px" id="starttime" value="<?php echo (date('Y-m-d H:i',($set["starttime"])?($set["starttime"]):time())); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="starttime">
到
<input type="input" class="px" id="endtime" value="<?php echo (date('Y-m-d H:i',($set["endtime"])?($set["endtime"]):strtotime('+1 month'))); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="endtime"></td>
</tr>
<tr>
  <th valign="top"><span class="red">*</span>每人总摇奖次数：</th>
  <td><input type="input" class="px" id="totaltimes" value="<?php echo ($set["totaltimes"]); ?>" name="totaltimes" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;请输入大于0的整数</td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>每人每天摇奖次数：</th>
  <td><input type="input" class="px" id="everydaytimes" value="<?php if($set["everydaytimes"] != ''): echo ($set["everydaytimes"]); else: ?>0<?php endif; ?>" name="everydaytimes" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;必须小于总摇奖次数,可以为0,0表示不限制直到消耗完总摇奖次数为止,请输入整数</td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>预计参与人数：</th>
  <td><input type="input" class="px" id="join_number" value="<?php echo ($set["join_number"]); ?>" name="join_number" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;预计参与人数直接影响中奖概率</td> 	
</tr>
<tr>
  <th valign="top">每人每次中奖时间间隔：</th>
  <td><input type="input" class="px" id="timespan" value="<?php if($set["timespan"] != ''): echo ($set["timespan"]); else: ?>0<?php endif; ?>" name="timespan" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;粉丝中奖之后xx分钟内不会中奖,摇奖次数依旧累加,默认为0表示不限制,单位为分钟</td> 	
</tr>
<tr>
  <th valign="top">获奖记录显示条数：</th>
  <td><input type="input" class="px" id="record_nums" value="<?php if($set["record_nums"] != ''): echo ($set["record_nums"]); else: ?>20<?php endif; ?>" name="record_nums" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red">该配置只用于其他人的中奖记录,粉丝自己的中奖记录会全部显示，</span>可以为0,若为0前台默认显示20条</td> 	
</tr>
<tr>
<th>限制每人每天中奖次数：</th>
<td><input type="input" class="px" id="is_limitwin" value="<?php if($set["is_limitwin"] != ''): echo ($set["is_limitwin"]); else: ?>0<?php endif; ?>" name="is_limitwin" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red">限制粉丝每天中奖的次数，0表示不限制，默认为0</td> 	
</tr>
<tr>
<th>未关注是否可以参与：</th>
<td>
  <input type="radio" name="is_follow" value="1" <?php if($set["is_follow"] == '1'): ?>checked<?php endif; ?>>
  是&nbsp;&nbsp;<input type="radio" name="is_follow" value="0" <?php if($set["is_follow"] == '0' or $set["is_follow"] == ''): ?>checked<?php endif; ?>>否<span style="width:318px;">&nbsp;&nbsp;&nbsp;<?php echo ($__access_remind__); ?></span>
</td>
</tr>
<tr>
<th>是否需要粉丝信息：</th>
<td>
  <input type="radio" name="is_register" value="1" <?php if($set["is_register"] == '1' or $set["is_register"] == ''): ?>checked<?php endif; ?>>
  是&nbsp;&nbsp;<input type="radio" name="is_register" value="0" <?php if($set["is_register"] == '0'): ?>checked<?php endif; ?>>否
  &nbsp;&nbsp;&nbsp;&nbsp;(没有粉丝详细信息参加活动的处理方式)
</td>
</tr>
<tr>
<th>活动状态：</th>
<td>
  <input type="radio" name="status" value="1" <?php if($set["status"] == '1' or $set["status"] == ''): ?>checked<?php endif; ?>>
  开启&nbsp;&nbsp;<input type="radio" name="status" value="0" <?php if($set["status"] == '0'): ?>checked<?php endif; ?>>关闭
</td>
</tr>
