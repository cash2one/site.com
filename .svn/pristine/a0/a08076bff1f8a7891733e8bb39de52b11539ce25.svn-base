											 ...
											 <span class="dianzan-more">
												 ...
												 <div class="fenxiang-more">
													<?php if($_SESSION['is_login']){ ?>
														...
														<div class="new-list">
															<?php foreach($output['favorites_class_data'] as $kfc => $vfc) { ?>
																<span onclick="selectKeepGoodsClass(<?php echo $vfc['favorites_class_id']; ?>, <?php echo $one_goods_list['goods_id']; ?>)"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/newimg/yixuanzhong.png" alt=""/><?php echo $vfc['favorites_class_name']; ?></span>
															<?php } ?>
														</div>
														<div class="new-list-two">
                                                            <span>创建新列表</span>
															<span>
																<input type="text" placeholder="创建新列表"/>创建
															</span>
														</div>
