...
.dialog-share .jcarousel-item a .extra { line-height: 20px; filter:progid:DXImageTransform.Microsoft.gradient(enabled='true',startColorstr='#BFff5400', endColorstr='#BFff5400');background:rgba(217,54,0,0.75); color: #FFF; display: none; width: 90px; height: 20px; position: absolute; z-index: 1; bottom: 0; left: 0;}
...
.dialog-share .bottom .button { color: #FFF; background-color: #ff5400; height: 28px; width: 80px; border: solid 1px #B22D00; cursor: pointer;}
