...
<TR>
  ...
  <TD rowspan="4" valign="top">
	  <div style="margin-left:20px">
		...
		<img id="pic1_src" src="<?php if($set['top_pic'] == ''): echo ($staticPath); ?>/tpl/static/Dajiangsai/images/default.jpg<?php else: echo ($set["top_pic"]); endif; ?>" width="373px" >
		<br />
		<input class="px"  name="top_pic" value="<?php if($set['top_pic'] == ''): echo ($staticPath); ?>/tpl/static/Dajiangsai/images/default.jpg<?php else: echo ($set["top_pic"]); endif; ?>" id="pic1" style="width:363px;"  />
		<br />
		<script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,1000,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;消息回复图片
	  </div>
  </TD>
</TR>
<TR>
...
<TR>
  ...
  <TD>
    <input class="px"  name="share_pic" value="<?php if($set['share_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Dajiangsai/images/default.jpg<?php else: echo ($set["share_pic"]); endif; ?>" id="pic2" style="width:310px;"  />
...
<TR>
  <th valign="top"><span class="red">*</span>回复内容缩略图：</th>
  <TD>
    <input class="px"  name="reply_pic" value="<?php if($set['reply_pic'] == ''): echo ($f_siteUrl); ?>/tpl/static/Dajiangsai/images/default.jpg<?php else: echo ($set["reply_pic"]); endif; ?>" id="pic01" style="width:310px;"  />
    <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic01',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic01')">预览</a>
  </TD>
</tr>
<TR>
...
<div class="msgWrap bgfc">
    <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;">温馨提示：奖项最多设置5个。单个奖项参数请填写完整，奖品图片宽高比例请尽量一致(正方形100*100)
    </div>
    <TABLE class="userinfoArea" style=" margin: 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic6',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic6')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
        ...
        <tr>
            ...
            <td>
                ...
                <script src="/tpl/static/upyun.js"></script>
                <a href="###" onclick="upyunPicUpload('pic7',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic7')">预览</a>
            </td>
        </tr>
        <TR>
            <th valign="top"><span class="red"></span>奖品数量：</th>
