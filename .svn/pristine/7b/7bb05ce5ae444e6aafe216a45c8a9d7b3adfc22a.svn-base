...
class store_goods_onlineControl extends BaseSellerControl {
    ...
    public function edit_save_goodsOp() {
        ...
        $update_common['goods_alias']         = $_POST['goods_alias'];//新增商品别名
        ...
        if (is_array ( $_POST ['spec'] )) {
            foreach ($_POST['spec'] as $value) {
                ...
                if (!empty($goods_info)) {
                    ...
                    $update['goods_alias']       = $update_common['goods_alias'];//新增商品别名
		    ...
		    // 生成商品二维码
                    ...
                    $insert['goods_alias']       = $update_common['goods_alias'];//新增商品别名
     ...
     * 编辑图片
     */
    public function edit_image_updateOp() {
