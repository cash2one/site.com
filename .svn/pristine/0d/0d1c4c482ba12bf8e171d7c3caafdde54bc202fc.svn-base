...
$(function(){
	$('.del_confirm').click(function(){
		if(!confirm('该分类下的文章也将同时被删除。请确认：是否确认删除该分类？')){
			return false;
		}
	});
});
...
<div class="cLineB">
	<h4>文章分类管理  <span class="FAQ"></span></h4>
...
<div class="cLineC" style="line-height: 32px;">
	<a href="<?php echo U('Web/news',array('act'=>'news_cat_add'));?>" class="btnGrayS vm bigbtn">添加分类</a>
</div>
...
<td class="norightborder" width="200" style="text-align:center;">
	<a href="<?php echo U('Web/news',array('act'=>'news_list','cat_id'=>$vo['cat_id']));?>">文章列表</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/news',array('act'=>'news_cat_edit','cat_id'=>$vo['cat_id']));?>">编辑</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/news',array('act'=>'news_cat_del','cat_id'=>$vo['cat_id']));?>" class="del_confirm">删除</a>
	</nobr>
</td>
