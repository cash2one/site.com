...
$(function(){
	$('.del_confirm').click(function(){
		if(!confirm('分类下的内容会连同删除！请确认：是否确认删除该分类？')){
			return false;
		}
	});
});
...
<div class="cLineB">
  <h4>图集分类管理  <span class="FAQ"></span></h4>
 ...
 <a href="<?php echo U('Web/flash',array('act'=>'cat_add'));?>" class="btnGrayS vm bigbtn">添加分类</a>　 
</div>
...
<p>分类关键词是网站获取分类下轮播图的唯一标识</p>
</span></a></th>
                        <th class="norightborder">操作</th>
</tr>
</thead>
<?php if(is_array($pc_flash_cat)): $i = 0; $__LIST__ = $pc_flash_cat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["cat_name"]); ?></td>
<td><?php echo ($vo["cat_key"]); ?></td>
<td class="norightborder" width="200">
	<a href="<?php echo U('Web/flash',array('act'=>'flash_list','cat_id'=>$vo['cat_id']));?>">图片列表</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/flash',array('act'=>'cat_edit','cat_id'=>$vo['cat_id']));?>">编辑</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/flash',array('act'=>'cat_del','cat_id'=>$vo['cat_id']));?>" class="del_confirm">删除</a>
	</nobr>
</td>
