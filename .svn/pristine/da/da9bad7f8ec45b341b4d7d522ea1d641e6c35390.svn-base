    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <?php } elseif ($output['payment']['payment_code'] == 'wxpay') { ?>
         <tr>
            <td colspan="2" ><p class="notic">如果启用微信在线退款功能需要在服务器设置“证书”，证书文件不能放在web服务器虚拟目录，应放在有访问权限控制的目录中，防止被他人下载。证书路径在“admin\api\refund\wxpay\WxPay.Config.php”中。退款有一定延时，用零钱支付的20分钟内到账，银行卡支付的至少3个工作日。</p></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><p class="notic">绑定支付的APPID（必须配置，开户邮件中可查看）</p></td>
        </tr>
        <tr>
          <td colspan="2" class="required">商户号: </td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input name="mchid" id="mchid" value="<?php echo $output['config_array']['mchid'];?>" class="input-txt" type="text">
                <span class="err"></span>
            </td>
          <td class="vatop tips"><p class="notic">商户号（必须配置，开户邮件中可查看）</p></td>
        </tr>
        <tr>
          <td colspan="2" class="required">密钥: </td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input name="key" id="key" value="<?php echo $output['config_array']['key'];?>" class="input-txt" type="text">
                <span class="err"></span>
            </td>
          <td class="vatop tips"><p class="notic">商户支付密钥，参考开户邮件设置（必须配置，登录商户平台自行设置）</p></td>
        </tr>
