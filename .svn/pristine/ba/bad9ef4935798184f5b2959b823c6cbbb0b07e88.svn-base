...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    <tr> 
      ...
      <td><input type="radio" name="pigcms_debug" value="1" <?php if(C('pigcms_debug')==='1')echo checked; ?> /> 开启调试 <input type="radio" name="pigcms_debug" value="0" <?php if(C('pigcms_debug')==='0')echo checked; ?> /> 关闭调试<span>&nbsp;&nbsp;打开调试模式后，如果系统有问题就能看到具体问题，需要玩艺售后排查问题的时候开启</span>
	  </td>
    </tr>
    <tr> 
      <td  height="48" align="right"><strong>网站名称：</strong></td>
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：玩艺官网</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.wantease.com</span>
    </tr> 
    <tr> 
   ...
   <tr>  
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td><input type="text" name="eqxsiteurl" value="<?php echo ($eqx_siteUrl); ?>" class="ipt" size="45" />
       <span>&nbsp;&nbsp;例:http://eqx.wantease.com</span>
      （有安装整合功能才有效）</tr>
      <tr> 
    ...
    <tr> 
      ...
      <td><input type="text" name="router_key" value="<?php echo C('router_key');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;买路由后请填写</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@wantease.com</span>
    </tr>
	<tr> 
