		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
					...
					<td>
					<div style="float:left;">
						模板名称：&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"><?php echo ($tplinfo['tpl_name']); ?></font><br/><br/><br/>
						模板预览：&nbsp;&nbsp;&nbsp;&nbsp;<img src="/tpl/Web/<?php echo ($tplinfo['tpl_file']); ?>/preview.jpg" style="vertical-align:middle;border:1px solid #ccc;"/>
					</div>
					<div style="float:left;margin-left:280px;padding-top:60px;">
						<a href="http://<?php echo ($first_pc_site); ?>" target="_blank"><img src="/tpl/Web/see_web.png" style="width:120px;"/></a>
					</div>
						<!--div id="now_tpl" style="border:1px solid #ccc;padding:20px 30px;overflow:hidden;margin-bottom:20px;"></div-->
					</td>
				</tr>
				
				<tr style="margin-bottom:20px;border-top:1px solid #ccc;">
					<th>模板列表</th>
					<td><br/>&nbsp;<br/>&nbsp;</td>
				</tr>
				<?php if(is_array($tpllist)): $i = 0; $__LIST__ = $tpllist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tpllist): $mod = ($i % 2 );++$i;?><tr style="margin-bottom:10px;border-top:1px solid #ccc;">
					<th>模板名称</th>
					<td><font color="red"><?php echo ($tpllist['tpl_name']); ?></font>
					</td>
				</tr>
				<tr>
					<th>模板预览：</th>
					<td>
						<div style="float:left;">
							<img src="/tpl/Web/<?php echo ($tpllist['tpl_file']); ?>/preview.jpg" style="vertical-align:middle;border:1px solid #ccc;"/>
						</div>
						<div style="float:left;margin-left:280px;padding-top:60px;">
								<input type="radio" name="id" value="<?php echo ($tpllist["id"]); ?>" <?php if($tpllist['id'] == $pc_config['tplid']): ?>checked<?php endif; ?>>
						</div>
					</td>
				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				<tr style="margin-bottom:10px;border-top:1px solid #ccc;">
					<th>提交选择：</th>
