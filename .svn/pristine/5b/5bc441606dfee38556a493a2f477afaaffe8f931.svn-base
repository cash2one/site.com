	...
	public function settingOp(){
		...
		if (chksubmit()){
			...
			if ($error != ''){
                ...
                $update_array['onempf_isuse'] = $_POST['onempf_isuse'];
				...
				$update_array['points_invite'] = intval($_POST['points_invite'])?$_POST['points_invite']:0;
                                $update_array['onempf_invite'] = intval($_POST['onempf_invite'])?$_POST['onempf_invite']:0;
            			$update_array['points_rebate'] = intval($_POST['points_rebate'])?$_POST['points_rebate']:0;
                                $update_array['onempf_rebate'] = intval($_POST['onempf_rebate'])?$_POST['onempf_rebate']:0;
