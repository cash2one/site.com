...
<div class="content" >
   ...
   <form class="form" method="post" id="form" action="" enctype="multipart/form-data"> 
    <div class="msgWrap bgfc"> 
     ...
     <tr> 
        <th><span class="red">*</span>回复关键词：</th>
     ...
     <tr> 
        ...
        <td><input type="text" name="reply_pic" value="<?php echo ($set["reply_pic"]); ?>" id="reply_pic" class="px" style="width:400px;"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('reply_pic',700,400,'<?php echo ($set["token"]); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('reply_pic')" class="a_upload">预览</a>&nbsp;填写图片外链地址，大小为720x400</td> 
       </tr>
	<tr> 
        <th><span class="red"></span>转发朋友圈介绍：</th> 
        <td><input type="text" id="intro" name="intro" value="<?php echo ($set["intro"]); ?>" class="px require" style="width:400px;" /></td> 
	</tr>
	<tr> 
        <th><span class="red"></span>广告微信号名称：</th> 
        <td><input type="text" id="adtitle" name="adtitle" value="<?php echo ($set["adtitle"]); ?>" class="px require" style="width:400px;" /></td> 
    </tr>
	<tr> 
        <th><span class="red"></span>广告微信号头像：</th> 
        <td><input type="text" name="ad_pic" value="<?php if($set['ad_pic'] != ''): echo ($set["ad_pic"]); else: ?>/tpl/static/pengyouquanad/images/a5.jpg<?php endif; ?>" id="ad_pic" class="px" style="width:400px;"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('ad_pic',150,150,'<?php echo ($set["token"]); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('ad_pic')" class="a_upload">预览</a>&nbsp;填写图片外链地址，大小为150X150</td> 
    </tr>
	<tr> 
        <th><span class="red"></span>广告地址：</th> 
        <td><input type="text" id="adurl" name="adurl" value="<?php echo ($set["adurl"]); ?>" class="px require" style="width:400px;" /></td> 
    </tr>
	<tr> 
        <th><span class="red"></span>广告微信号图片：</th> 
        <td><input type="text" name="adimg" value="<?php if($set['adimg'] != ''): echo ($set["adimg"]); else: ?>/tpl/static/pengyouquanad/images/c6.jpg<?php endif; ?>" id="adimg" class="px" style="width:400px;"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('adimg',700,400,'<?php echo ($set["token"]); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('adimg')" class="a_upload">预览</a>&nbsp;填写图片外链地址，大小为720x400</td> 
    </tr>
	<tr> 
        <th><span class="red"></span>广告微信号内容：</th> 
        <td><input type="text" id="adinfo" name="adinfo" value="<?php echo ($set["adinfo"]); ?>" class="px require" style="width:400px;" /></td> 
    </tr>
	<tr> 
        <th><span class="red"></span>底部推荐公众号名字：</th> 
        <td><input type="text" id="gongzhonghao" name="gongzhonghao" value="<?php if($set['gongzhonghao'] != ''): echo ($set["gongzhonghao"]); else: ?>这里是公众号中文名字<?php endif; ?>" class="px require" style="width:400px;" /></td> 
    </tr>
	<tr> 
        <th><span class="red"></span>底部推荐公众号二维码：</th> 
        <td><input type="text" name="gzh_ewm" value="<?php if($set['gzh_ewm'] != ''): echo ($set["gzh_ewm"]); else: ?>/tpl/static/pengyouquanad/images/c8.jpg<?php endif; ?>" id="gzh_ewm" class="px" style="width:400px;"  /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('gzh_ewm',700,400,'<?php echo ($set["token"]); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('gzh_ewm')" class="a_upload">预览</a>&nbsp;填写图片外链地址，大小为720x400</td> 
    </tr>
	<tr> 
        <th><span class="red"></span>底部推荐公众号ID：</th> 
        <td><input type="text" id="gzhid" name="gzhid" value="<?php if($set['gzhid'] != ''): echo ($set["gzhid"]); else: ?>公众号ID<?php endif; ?>" class="px require" style="width:400px;" /></td> 
    </tr>
	<TR>
		<th valign="top"><span class="red"></span>是否开启：</th>
		<td>
		<input type="radio" name="stats" value="1" <?php if($set['stats'] == '' or $set['stats'] == 1): ?>checked<?php endif; ?>>开启&nbsp;&nbsp;&nbsp;
		<input type="radio" name="stats" value="2" <?php if($set['stats'] == 2): ?>checked<?php endif; ?>>关闭
		</td>
	</TR>
     <tr>         
       <th>&nbsp;</th>
