...
<form class="frontpageform" method="post" action="<?php echo U('FrontPage/addaction',array('token'=>$this->token));?>">
<div class="content">
<div class="cLineB">
  <h4>设置活动信息</h4><a href="<?php echo U('FrontPage/index',array('token'=>$this->token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回活动列表</a></div>
<div class="msgWrap bgfc">
<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
<tbody>
<tr>
  <th valign="top"><span class="red">*</span>活动名称：</th>
  <td><input type="input" class="px" id="action_name" value="<?php if($set["action_name"] != ''): echo ($set["action_name"]); else: ?>我要上头条<?php endif; ?>" name="action_name" style="width:400px"></td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>关键词：</th>
  <td><input type="input" class="px" id="keyword" value="<?php if($set["keyword"] != ''): echo ($set["keyword"]); else: ?>我要上头条<?php endif; ?>" name="keyword" style="width:400px"></td> 	
</tr>
<tr>
...
<tr>
  ...
  <td>  <?php if($set["reply_pic"] != ''): ?><img class="thumb_img" id="pic0_src" src="<?php echo ($set["reply_pic"]); ?>" style="max-height:100px;max-width: 200px;">
	<?php else: ?>
	<img class="thumb_img" id="pic0_src" src="<?php echo ($staticPath); ?>/tpl/static/frontpage/images/frontpage.jpg" style="max-height:100px;max-width: 200px;"><?php endif; ?>
  <input type="text" name="reply_pic" value='<?php if($set['reply_pic'] != ''): echo ($set["reply_pic"]); else: echo ($staticPath); ?>/tpl/static/frontpage/images/frontpage.jpg<?php endif; ?>' id="pic0" class="px" style="width:200px;" >
...
<tr>
  ...
  <td><input type="input" class="px" id="remind_word" value="<?php echo ($set["remind_word"]); ?>" name="remind_word" style="width:400px">&nbsp;&nbsp;&nbsp;&nbsp;不超过15个字 </td>
</tr>
<tr>
  <th valign="top"><span class="red">*</span>顶部广告logo:</th>
  <td><input type="text" name="remind_img" value='<?php if($set['remind_img'] != ''): echo ($set["remind_img"]); else: echo ($staticPath); ?>/tpl/static/frontpage/images/logo.png<?php endif; ?>' id="pic1" class="px" style="width:400px;">
  <a href="###" onclick="upyunPicUpload('pic1',0,0,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a></td>
</tr>
<tr>
  <th valign="top"><span class="red">*</span>顶部广告跳转地址:</th>
  <td><input type="input" class="px" id="remind_link" value="<?php echo ($set["remind_link"]); ?>" name="remind_link" style="width:400px"> <?php if(session('isQcloud') != true): ?><a href="###" onclick="addLink('remind_link',0)" class="a_choose">功能库添加</a><?php endif; ?></td>
</tr>
<tr>
...
到
<input type="input" class="px" id="end_time" value="<?php echo (date('Y-m-d H:i',($set["end_time"])?($set["end_time"]):strtotime('+1 month'))); ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="end_time"></td>
</tr>
<tr>
  <th valign="top">手机端显示赞助商：</th>
  <td><input type="input" class="px" id="sponsors" value="<?php echo ($set["sponsors"]); ?>" name="sponsors" style="width: 200px;">&nbsp;&nbsp;&nbsp;&nbsp;不超过10个字</td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>每人每天允许制作新闻条数：</th>
  <td><input type="input" class="px" id="day_create" value="<?php if($set["day_create"] != ''): echo ($set["day_create"]); else: ?>0<?php endif; ?>" name="day_create" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;必须小于总共允许条数,可以为0,0表示不限制直到达到总共新闻条数为止,请输入整数</td> 	
</tr>
<tr>
  <th valign="top"><span class="red">*</span>每人总共允许制作新闻条数：</th>
  <td><input type="input" class="px" id="total_create" value="<?php echo ($set["total_create"]); ?>" name="total_create" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;请输入大于0的整数</td> 	
</tr>
<tr>
  <th valign="top">轮播显示最新的新闻条数：</th>
  <td><input type="input" class="px" id="latest_count" value="<?php echo ($set["latest_count"]); ?>" name="latest_count" style="width:120px">&nbsp;&nbsp;&nbsp;&nbsp;请输入大于0的整数,不填默认显示最新的十条</td> 	
</tr>
<tr>
<th>未关注是否可以参与：</th>
<td>
...
<td>
  ...
  开启&nbsp;&nbsp;<input type="radio" name="status" value="0" <?php if($set["status"] == '0'): ?>checked<?php endif; ?>>关闭&nbsp;&nbsp;<span style="color:red;">如果配置信息未配置或配置的全部过期，则活动默认修改为关闭状态</span>&nbsp;&nbsp;&nbsp;<a href="<?php echo U('FrontPage/listconfigure',array('token'=>$this->token));?>" target="_blank"><span style="color:green;">配置信息</span></a>
</td>
</tr>
<tr>
<th>&nbsp;</th>
...
<a href="<?php echo U('FrontPage/addaction',array('id'=>$set['id']));?>" class="btnGray vm">取消</a>
</td>
</tr>
</tbody>
</table>
