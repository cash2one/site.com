    ...
    <div class="main">
        ...
        <div class="all jian">
            ...
            <div class="huigu-everyone">
                ...
                <div class="pic"><a href="<?php echo $article_url; ?>"><img src="<?php echo 'http://www.wantease.com'.DS.DIR_UPLOAD.DS.ATTACH_CMS.DS.'article'.DS.$value['article_publisher_id'].DS.unserialize($value['article_image'])['name']; ?>" alt=""/></a></div>
                  <?php } ?>
                <div class="everyone-text">
                    <div>
                        <span class="huoname"><a href="<?php echo $article_url; ?>"><?php echo $value['article_title']; ?></a></span>
                    </div>
