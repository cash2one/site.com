...
<div class="content">
	...
	<div class="cLineB">
		 ...
		 <h4>软文添加</h4>  <a href="<?php echo U('Adcms/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a> 
	...
	<form class="form" method="post" id="form" action="" enctype="multipart/form-data">
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tbody>
                  <tr>
						...
						<th><span class="red">*</span>该篇软文广告费用：</th>

						<td>

							<input type="text" id="adrmb" name="adrmb" placeholder=" 请输入广告费用金额" value="<?php echo ($info["adrmb"]); ?>" class="px" style="width:400px;" />
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="sjname" placeholder=" 请输入商家名称" value="<?php echo ($info["sjname"]); ?>" class="px" style="width:400px;" />

						</td>

					</tr>
                   <tr>
                   <th><span class="red">*</span>文章所属类别：</th>
                   <td><select name="type" id="auth2nd" class="input-medium">
					<option value="1">今日头条</option>
					<option value="2">生活百科</option>
					<option value="3">情感人生</option>
					<option value="4">搞笑轻松</option>
                    <option value="5">职场智慧</option>
                     <option value="6">旅游星座</option>
				</select></td>
                   </tr>
					<tr>

						<th><span class="red">*</span>标题名称：</th>

						<td>

							<input type="text" id="name" name="title" placeholder=" 请输入标题" value="<?php echo ($set["title"]); ?>" class="px" style="width:400px;" />
		...
		<tr>
			...
			<TR>
				...
				<TH valign="top"><span class="red">*</span>内容：</TH>

				<TD>

					<textarea name="contents" id="content" rows="5" style="width:590px;height:360px"><?php echo ($set["contents"]); ?></textarea>
            ...
            <tr>
						 ...
						 <TH valign="top"><label for="pic">顶部广告：</label></TH>

						 <TD><input type="text" class="px"  name="topad" id="topad" value="" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="#" onclick="upyunPicUpload('topad',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('topad')">预览</a>
                    ...
                    <tr>
						...
						<th><span class="red">*</span>顶部广告链接：</th>

						<td>

							<input type="text" id="topad_url" name="title" placeholder=" 请输入链接" value="<?php echo ($set["topad_url"]); ?>" class="px" style="width:400px;" />
