...
<div class="title" > <i></i>
  <h3><a href="<?php echo urlShop('search', 'index');?>"><?php echo $lang['nc_all_goods_class'];?></a></h3> 
</div>
<div class="category">
  <ul class="menu">
          ...
          <div class="brands-list">
            ...
            <ul>
              <?php foreach ($rec_brand as $keys => $brand) {
                           if ($n++ < 10) {
                        ?>
              <li> <a title="<?php echo $brand['brand_name'];?>" href="<?php echo urlShop('brand','list',array('brand'=> $brand['brand_id'])); ?>"><img width="90" alt="<?php echo $brand['brand_name'];?>" heiht="30" src="<?php echo brandImage($brand['brand_pic']);?>"></a></li>
              <li><img width="90" alt="<?php echo $brand['brand_name'];?>" heiht="30" src="<?php echo brandImage($brand['brand_pic']);?>"></li>
              <?php } ?>
              <?php } ?>
            </ul>
            <?php } ?>
