...
<body> 
<!--	    <div class="toubu-guanggao" id="toubu-guanggao" >
		     <img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/toubuguanggao.png">
			 <span id="closeTOPgg" onclick="clickclose()"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/close.png"></span>
		</div>-->
        ...
        <div class="header-wrap">
            <header class="public-head-layout wrapper" >
                <h1 class="site-logo"><a href="<?php echo BASE_SITE_URL; ?>"><img src="<?php echo UPLOAD_SITE_URL . DS . ATTACH_COMMON . DS . $output['setting_config']['site_logo']; ?>" class="pngFix"></a><img src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/logo_02.png"></h1> 
				
                <!--  <div class="header_log">
                        <span class="header_log_span2"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" value="" style="color:#fff;font-size:14px;">申请商家入驻</a></span>
                </div> -->
...
//设置cookie     
	...
	function clickclose(){
		$("#toubu-guanggao").slideUp();
		setCookie("ads","no",0);
	}
	function checkads(){
		if(getCookie("ads")=="no"){
		    document.getElementById('toubu-guanggao').style.display='none';
		}else{
			document.getElementById('toubu-guanggao').style.display='block';
		}
	}
...
(function() {
  ...
  hm.src = "//hm.baidu.com/hm.js?d73b8542999a33af857c7c61122e4d8b";
