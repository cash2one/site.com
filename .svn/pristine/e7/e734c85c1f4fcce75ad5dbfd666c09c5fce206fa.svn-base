...
<div class="cLineB">
 ...
 <a href="<?php echo U('Classify/index',array('fid'=>$zid));?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a>
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a href="<?php if($fid != 0): echo U('Classify/add',array('fid'=>$fid)); else: echo U('Classify/add'); endif; ?>" class="btnGrayS vm bigbtn"><?php if($usertplid == 2): ?><i class="fa fa-hand-o-right"></i><?php else: ?><img src="<?php echo RES;?>/images/product/add.png" class="vm"><?php endif; ?> 添加<?php if($fid != 0): ?>【<?php echo ($thisClassify["name"]); ?>】子<?php endif; ?>分类</a>　
</div>
...
<th style=" width:80px">分类图片 <a target="999" class="tooltips" ><?php if($usertplid == 2): ?><i class="fa fa-bullhorn" style="color:#1ab394;"></i><?php else: ?><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><?php endif; ?><span>
<p>分类图片最佳尺寸：宽720高400</p>
<p>不支持上传图片，请把图片上传到腾讯微博，再这里填写图片的外链地址。</p>
<p>如果不填写分类图片地址系统将随机分配默认图片。</p>
</span></a></th>
<th>外链网站或活动 <span class="tooltips" ><?php if($usertplid == 2): ?><i class="fa fa-bullhorn" style="color:#1ab394;"></i><?php else: ?><img src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><?php endif; ?><span>
