...
var invoice_id = 0;
var address_id, vat_hash, offpay_hash, offpay_hash_batch, voucher, pd_pay,onempf_pay, password, fcode = "",
    ...
    var _init = function(e) {
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                if ($.isEmptyObject(e.datas.address_info ) && (is_happysend==0)) {
                    $.sDialog({
                        skin: "block",
                        content: "请添加地址",
                        okFn: function() {
                ...
                for (var t in e.datas.store_cart_list) {
                    $("#storeTotal" + t).html(e.datas.store_cart_list[t].store_goods_total);
                    a = parseFloat(e.datas.store_final_total_list[1]);
                    message[t] = "";
