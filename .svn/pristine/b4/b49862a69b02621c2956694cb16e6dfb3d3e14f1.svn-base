...
<div id="content" class="wrapper pr">
  ...
  <div class="ncs-detail<?php if ($output['store_info']['is_own_shop']) echo ' ownshop'; ?>">
    ...
    <div class="ncs-goods-summary">
        ...
        <dl>
          ...
          <dd class="price">
            ...
            <?php if (isset($output['goods']['goods_promotion_price']) && !empty($output['goods']['goods_promotion_price'])) {?>
                <strong><?php echo $lang['currency'].$output['goods']['goods_promotion_price'];?></strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].$output['goods']['goods_price'];?>)</em>
            <?php } else {?>
      ...
      <!-- S 购买按钮 -->
		...
		<!-- 商品服务提供商-->
		<div class="v4-key">服务</div>
		<div class="v4-value">该商品由<?php echo $output['store_info']['store_name']; ?>发货，承诺48小时内发出。</div>

		<!-- 服务保障标识-->
		<div class="v4-nokey-value">
		<div class="v4-attri-tagbox">
					<span class="attri-100r">
						100%真品承诺
						<em class="attri-tag"></em>
					</span>
					<span class="attri-rp7">
						7天无条件退换
						<em class="attri-tag"></em>
					</span>
					<span class="attri-sp7">
						7天低价保证
						<em class="attri-tag"></em>
					</span>
					<span class="attri-fs">
  ...
  <div class="ncs-goods-layout" > <!-- 增加 expanded 默认显示侧边栏-->
        ...
        <div class="ncs-goods-info-content bd" id="ncGoodsRate">
          <div class="top">
            ...
            <div class="btns"><span>您可对已购商品进行评价</span>
              <p ><a href="<?php if ($output['goods']['is_virtual']) { echo urlShop('member_vr_order', 'index');} else { echo urlShop('member_order', 'index');}?>" class="ncs-btn ncs-btn-cyan" target="_blank"><i class="icon-comment-alt"></i>评价商品</a></p>
            </div>
          </div>
          <div class="ncs-goods-title-nav">
            <ul id="comment_tab">
