...
<?php if($wxuser["winxintype"] == 3): ?><th width="80">状态</th><?php endif; ?>
...
<td><?php if($c["add_time"] != 0): echo (date('Y-m-d H:i:s',$c["add_time"])); else: ?>---<?php endif; ?></td>
<?php if($wxuser["winxintype"] == 3): ?><td><?php if($c['available_state'] == 2): ?><span style="color:red;">审核中</span><?php elseif($c['available_state'] == 3): ?><span style="color:green;">审核通过</span><?php elseif($c['available_state'] == 4): ?><span style="color:red;">审核驳回</span><?php endif; ?></td><?php endif; ?>
