  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="activity_bg">背景图片:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
            <span class="type-file-show">
                <img class="show_image" src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png" />
                <div class="type-file-preview"><img src="<?php if(is_file(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_bg'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$output['activity']['activity_bg'];}else{echo "";}?>" onload="javascript:DrawImage(this,500,500);"></div>
            </span>
            <span class="type-file-box">
                <input type="file" class="upload-activity-bg" id="activity_bg" name="activity_bg" size="30" hidefocus="true"  nc_type="upload_activity_bg" title="<?php echo $lang['activity_index_bg'];?>">
            </span>
          </td>
          <td class="vatop tips">主体背景上传</td>
        </tr>
...
<!-- 模板 -->
        <tr>
          <td colspan="2" class="required">模板选择:</label></td>
        </tr>

        <tr class="noborder">
          <td class="vatop rowform"><select id="activity_temp" name="activity_temp">
              <option value="default">默认模板</option>
              <option value="class">模板1</option>
              <option value="waterfall">模板2</option>
              <option value="step">模板3</option>
            </select></td>
          <td class="vatop">请选择该活动所在页面的模板</td>
        </tr>
