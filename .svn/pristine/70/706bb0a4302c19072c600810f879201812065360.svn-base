...
<div class="cLineB">
  ...
  <div class="ftip" style="margin:25px auto 5px auto;">粉丝总人数：<?php echo ($count); ?> &nbsp;&nbsp;&nbsp;&nbsp;粉丝赚取总金额：<?php echo ($sum); ?>&nbsp;&nbsp;&nbsp;&nbsp;粉丝总可提现余额：<?php echo ($sumye); ?></div>
  <div class="cLine">
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <THEAD>
                ...
                <TR valign="top">
                    ...
                    <TH style="text-align:center" width="5%">省</TH>
                     <TH style="text-align:center" width="5%">市</TH>
                    <TH style="text-align:center" width="5%">下线</TH>

					 <TH style="text-align:center"  width="10%">可提现余额</TH>

                    <TH style="text-align:center"  width="10%">总收益</TH>
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td style="text-align:center"><?php echo ($vo["name"]); ?></td>
                     ...
                     <td style="text-align:center"><span><?php echo ($vo["province"]); ?></span></td>
                      <td style="text-align:center"><span><?php echo ($vo["city"]); ?></span></td>
 <td style="text-align:center"><span><?php echo ($vo["fans"]); ?></span></td>
                    <td style="text-align:center"><?php echo ($vo["balance"]); ?></td>

                 <td style="text-align:center"><?php echo ($vo["total_balance"]); ?></td>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Adcms/exchange',array('id'=>$vo['id'],'token'=>$vo['token'],'wecha_id'=>$vo['wecha_id']));?>" title="提现记录">提现记录</a>
                   <a href="<?php echo U('Adcms/user_fans',array('id'=>$vo['id'],'token'=>$vo['token'],'wecha_id'=>$vo['wecha_id']));?>" title="下级粉丝">下级粉丝</a>

				   <a href="<?php echo U('Adcms/user_del',array('id'=>$vo['id'],'token'=>$vo['token']));?>">删除</a></td>
