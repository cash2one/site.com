        ...
        <li><a href="JavaScript:void(0);" >编辑</a></li>
         <li><a href="index.php?act=goods&op=add_attr"><span><?php echo '新增价格';?></span></a></li>
          <li><a href="index.php?act=goods&op=add_attr_1"><span><?php echo '新增关系';?></span></a></li>
           ...
           <li><a href="index.php?act=goods&op=add_attr_3" class="current"><span><?php echo '新增收件人年龄';?></span></a></li>
      </ul>
      <a href="goods.add.php"></a>
    </div>
  </div>
  <div class="fixed-empty"></div>
  <form id="post_form" method="post" action="" id="post_form">
    <input type="hidden" name="form_submit" value="ok" />
    <table class="table tb-type2">
      <tbody>
       	<tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="attr_value_name">收件人年龄:</label></td>
        </tr>
        <tr class="noborder">
