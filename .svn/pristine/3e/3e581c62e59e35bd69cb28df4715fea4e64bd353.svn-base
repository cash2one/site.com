...
<style>
    ...
    #homeTopAd01{z-index:999;}
    .red{ position:absolute; top:0px; left:0;  width:100%; margin:0 auto; transition:ease 1s;z-index:999;display: inline-block;}
    .zzz{ width:100%; height:151px; overflow:hidden; transition:ease 1s;}
    .zzz:hover{ height:634px; transition:ease 0.7s;}
    .zzz:hover .red{top:-151px;transition:ease 1s;}
    .zzz:hover .green{height:634px;transition:ease 0.7s;}
    
    .green{ margin:0 auto;width:1920px;height:151px;position:absolute;overflow:hidden;z-index:1;transition:ease 0.7s;}
    .green a{display:inline-block;width:1200px;margin:0 auto;}
    .green-left{ float:left; width:360px;} 
    .green-cont{  display:block; float:left; width:1200px; height:634px; background:url(<?php echo SHOP_TEMPLATES_URL; ?>/images/12121.jpg) no-repeat center;}
    .green-right{ float:right; width:360px;} 
    .blue{ z-index:1;}
    .one{left:-100%; transition:ease 1s;}
    .app{ position:fixed; left:0; bottom:0; width:100%; height:226px;z-index: 10000;background-color: rgba(60,60,60,.95); color:#fff; text-align:center; transition:ease 1s;}
    .app-cont{position: relative;min-height: 50px;margin: 0 auto;font-size: 0;overflow: hidden;}
    ...
    <body>
      <!--//zmr>v92页头top广告-->
        <?php if (loadadv(1047)) { ?>
        <div class="zzz">
            <DIV id=homeTopAd01 class="red"  style=" position:absolute;  margin:0 auto; width:100%;">
                <div style="margin:0 auto; width:1200px;" ><?php echo loadadv(1047); ?></div>
                <div style=" position:absolute; z-index:1; top:5px; right:25px; "><a style="CURSOR: hand" onClick="homeTopAd()"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/close.png" width="24" height="24" /></a></div>
            </DIV>

            <div class="green">
               <div class="green-left"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/12121-l.jpg" alt=""></div>
                <a class="green-cont" href="http://www.wantease.com/shop/index.php?act=show_groupbuy&op=index"></a>
               <div class="green-right"><img src="<?php echo SHOP_TEMPLATES_URL; ?>/images/12121-r.jpg" alt=""></div>
            </div>
        </div>
        ...
        <div class="header-wrap">
            <header class="public-head-layout wrapper" >
                ...
                <div id="search" class="head-search-bar">
                    ...
                    <table class="w-w1b" style="width:305px;height:30px;" >
                        <tr>
                            <td>
                                ...
                                <div class="t-sou">
                                    <form method="get" action="<?php echo SHOP_SITE_URL; ?>">
                                        ...
                                        <span class="t-sou-suo t-sou-yjiao">搜索</span>
                                        <input class="t-sou-input t-sou-yjiao" style="" placeholder="请输入关键字" name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $_GET['keyword']; ?>">
                                        <input class="t-sou-submit t-sou-yjiao" type="submit" value="">
                                        <span class="t-sou-icon t-sou-yjiao"><input type="submit" id="button" value="" class="input-submit"></span>
                                    </form>
                                </div> 
...
<!--  <li><a href="<?php echo urlShop('brand', 'index'); ?>" <?php
        ...
        <style>/*搜索*/
            ...
            .t-sou-icon{
                ...
                text-align: center;
                cursor: pointer;
                background:url(<?php echo SHOP_TEMPLATES_URL; ?>/images/index/sear.png) no-repeat center center;
                z-index: 91;
            }
            .t-sou-suo{
                width: 34px;
