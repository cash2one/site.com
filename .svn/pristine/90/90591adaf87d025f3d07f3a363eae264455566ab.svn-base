...
function like_drop(e) {
    ...
    $.ajax({
        type: "get",
        url: ApiUrl1 + "/index.php?act=micro_like&op=like_drop",
        data: {
            key: t,
            like_id: e
        },
...
//			window.location.href=ApiUrl+"/index.php?act=auto&op=login&ref="+encodeURIComponent(window.location.href);
                    ...
                    window.location.href=SiteUrl+"/index.php?act=connect_wx&op=wap&url"+url;
