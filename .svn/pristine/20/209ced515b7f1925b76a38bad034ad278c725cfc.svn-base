...
<div class="new_pub">
            ...
            <div class="topic_box" style="width:1000px">
                    <div class="question_box" id="question_info_1">
                   
                 
                    <ul id="1" class="optionul">
                     <li>
                            <span></span><u>抽奖概率设置：</u>
                           
                            <span style="width:140px; margin-left:140px">钱数（单位：分）</span>
                             <span style="width: 267px;
  margin-left: 100px;">概率（单位：%）最低0.01，小数点后两位</span>
                        ...
                        <li>
                            ...
                            <input type="text" class="txt" value="<?php echo ($info["r1"]); ?>" name="r1">
                            <input type="text" class="rand" style="width:150px; float:none" value="<?php echo ($info["rand1"]); ?>" name="rand1">%
                        ...
                        <li>
                            ...
                            <input type="text" class="txt" value="<?php echo ($info["r2"]); ?>" name="r2">
                           <input type="text" class="rand" style="width:150px; float:none"  value="<?php echo ($info["rand2"]); ?>"name="rand2">%
                        ...
                        <li>
                            <span>C</span><u>概率：</u>
                             ...
                             <input type="text" class="txt" value="<?php echo ($info["r3"]); ?>" name="r3">
                             <input type="text" class="rand" style="width:150px; float:none" value="<?php echo ($info["rand3"]); ?>" name="rand3">%
                         ...
                         <li>
                            <span>D</span><u>概率：</u>
                             ...
                             <input type="text" class="txt" value="<?php echo ($info["r4"]); ?>" name="r4">
                             <input type="text" class="rand" style="width:150px; float:none"  value="<?php echo ($info["rand4"]); ?>"name="rand4">%
                          ...
                          <li>
                            <span>E</span><u>概率：</u>
                             ...
                             <input type="text" class="txt" value="<?php echo ($info["r5"]); ?>" name="r5">
                             <input type="text" class="rand" style="width:150px; float:none" value="<?php echo ($info["rand5"]); ?>" name="rand5">%
		...
		<ul class="pub_list">
		<li class="bot">
      	<input class="btnGreen" type="submit" id="submit" value="保存"> &nbsp; <a href="<?php echo U('Research/index',array('token'=>$token));?>" class="btnGray vm">取消</a>
      	</li>
		</ul>
</ul>     
</form>
