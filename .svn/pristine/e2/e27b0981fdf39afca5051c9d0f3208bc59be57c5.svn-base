  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center"><?php echo $lang['admin_predeposit_cash_shoukuanbank']; ?></th>
        <th class="align-center"><?php echo $lang['admin_predeposit_cash_shoukuanaccount'];?></th>
        <th class="align-center"><?php echo $lang['admin_predeposit_cash_shoukuanname'];?></th>
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo @date('Y-m-d H:i:s',$v['pdc_payment_time']); ?></td>
