  ...
  <script>
	...
	function more(){
		...
		$(".showmore").text('正在加载...');
                                        ...
                                        $.get("index.php?g=Wap&m=Hongbaoqiye&a=pagess&wecha_id=<?php echo ($wecha_id); ?>&token=<?php echo ($token); ?>", {aid:"{$act['id']}",p:page} ,function(result){
 ...
 <body> 
  ...
  <div class="index"> 
   <div class="top"> 
    ...
    <a href="index.php?g=Wap&m=Hongbaoqiye&a=cbt&token=<?php echo ($token); ?>&wecha_id=<?php echo ($wecha_id); ?>" style="color:white"> 藏宝图</a>    </div> 
   </div> 
   <div class="member"> 
   <?php if($pid_info == ''): ?><div class="head">
     <img src="<?php echo ($user_info["portrait"]); ?>" />
    </div> 
   ...
   <div class="record">
    <?php if($record == ''): ?><div class="line"> 
     <p style="text-align: center; color: #999">还木有小伙伴上榜~</p> 
    </div><?php endif; ?>
