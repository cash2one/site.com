    ...
    <tr> 
      <td  height="48" align="right"><strong>选择模板：</strong></td>
         <td> <select name="beer" id="beer" onChange="setBeerIcon();">
            ...
            <option value="wdl">2015</option>
            <option value="html">html</option>
			<option value="weidogs">微信狗风格</option>
		    <option value="weidogsfx">微信狗分销风格</option>
		    <option value="weikelai">微客来风格</option>
		    <option value="weijiang">微匠风格</option>
            <option value="lieshou">猎手风格</option>
        </select>
    </td>
