	...
	<form class="form" method="post" id="form" action="" enctype="multipart/form-data">
		...
		<div class="msgWrap bgfc">
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tbody>
                 <tr>
          <th valign="top">点赚客入口:</th>
          <td><span class="red">http://<?php echo $_SERVER['HTTP_HOST'] ?>/index.php?g=Wap&m=Adcms&a=index&token=<?php echo ($token); ?></span></td>
        </tr>
         <tr>
          <th valign="top">我的邀请码入口:</th>
          <td><span class="red">http://<?php echo $_SERVER['HTTP_HOST'] ?>/index.php?g=Wap&m=Adcms&a=invite&token=<?php echo ($token); ?></span></td>
        </tr>
                   <tr>
                   <th>公众号名称</th>
                   <td><input type="text" id="wxname" name="wxname" placeholder=" 请输入公众号名称" value="<?php echo ($set["wxname"]); ?>" class="px" style="width:400px;" /></td>
                   </tr>
                    <tr>
						...
						<td>
							...
							<input type="text" id="mbid" name="mbid" placeholder=" 请输入模板ID" value="<?php echo ($set["mbid"]); ?>" class="px" style="width:400px;" />编号为：OPENTM202967310
                    ...
                    <tr>
						...
						<td>
							...
							<input type="text" id="xiaxianid" name="xiaxianid" placeholder=" 请输入模板ID" value="<?php echo ($set["xiaxianid"]); ?>" class="px" style="width:400px;" />编号为：OPENTM202425107
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="quyus" placeholder=" 限制活动区域" value="<?php echo ($set["quyus"]); ?>" class="px" style="width:400px;" />只限该省的用户参与，通过ip定位,多个用‘、’隔开
						</td>
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="quyu" placeholder=" 限制活动区域" value="<?php echo ($set["quyu"]); ?>" class="px" style="width:400px;" />只限该市的用户参与，通过ip定位，多个用‘、’隔开
						</td>
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="quyux" placeholder=" 限制活动区域" value="<?php echo ($set["quyux"]); ?>" class="px" style="width:400px;" />只限该县的用户参与，通过ip定位，多个用‘、’隔开
						</td>

					</tr>
                    <tr>
                   <th>公众号引导链接</th>
                   <td><input type="text" id="wxurl" name="wxurl" placeholder=" 请输入公众号引导链接" value="<?php echo ($set["wxurl"]); ?>" class="px" style="width:400px;" /></td>
                   </tr>
                    ...
                    <tr>
						...
						<td>
							...
							<input type="text" id="sjtg" name="sjtg" placeholder=" 请输入商家推广链接" value="<?php echo ($set["sjtg"]); ?>" class="px" style="width:400px;" />
					...
					<tr>
						 ...
						 <TH valign="top"><label for="pic">新手指导链接：</label></TH>

						 <TD><input type="text" id="xszd" name="xszd" placeholder=" 请输入新手指导链接" value="<?php echo ($set["xszd"]); ?>" class="px" style="width:400px;" />
                    	...
                    	<tr>
						 ...
						 <TH valign="top"><label for="pic">分享点击可赚：</label></TH>

						 <TD><input type="text" id="name" name="rmb" placeholder=" 请输入金额" value="<?php echo ($set["rmb"]); ?>" class="px" style="width:200px;" />元
                     ...
                     <tr>
						 ...
						 <TH valign="top"><label for="pic">下线佣金：</label></TH>

						 <TD><input type="text" id="name" name="yj" placeholder=" 请输入佣金" value="<?php echo ($set["yj"]); ?>" class="px" style="width:200px;" />%
                      ...
                      <tr>
						 ...
						 <TH valign="top"><label for="pic">提现方式：</label></TH>

						 <TD><select name="txtype" id="auth2nd" class="input-medium">
					<option value="1" <?php if($set["txtype"] == '1'): ?>selected="selected"<?php endif; ?>>微信红包提现</option>
					<option value="2" <?php if($set["txtype"] == '2'): ?>selected="selected"<?php endif; ?> >手动打款</option>
