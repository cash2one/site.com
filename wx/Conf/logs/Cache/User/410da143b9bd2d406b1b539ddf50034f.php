...
<div class="cLineB">
  ...
  <div class="ftip" style="margin:25px auto 5px auto;">总提现记录：<?php echo ($sqtx); ?> &nbsp;&nbsp;&nbsp;&nbsp;已打款：<?php echo ($ytx); ?>&nbsp;&nbsp;&nbsp;&nbsp;待打款：<?php echo ($dcl); ?></div>
   <div class="ftip" style="margin:25px auto 5px auto;">总提现金额：<?php echo ($zje); ?> &nbsp;&nbsp;&nbsp;&nbsp;已经提现金额：<?php echo ($ztxje); ?>&nbsp;&nbsp;&nbsp;&nbsp;待打款金额：<?php echo ($zdtxje); ?></div>
  <div class="cLine">
<div class="pageNavigator left" style=" margin-right:30px"> <a href="<?php echo U('Adcms/exportForms',array('token'=>$token));?>" title="导出提现数据" class="btnGrayS vm bigbtn">导出提现数据</a> </div>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td style="text-align:center"> <img src="<?php echo ($vo["headpic"]); ?>" style="width:50px"></td>

                  <td style="text-align:center"><?php echo ($vo["name"]); ?></td>
                   <td style="text-align:center"><?php echo ($vo["wecha_id"]); ?></td>

                    <td style="text-align:center"><?php echo ($vo["alipay_money"]); ?></td>

                 <td style="text-align:center"><?php echo (date('Y-m-d H-i-s',$vo["time"])); ?></td>
                   <td style="text-align:center"><?php if($vo["statue"] == '0'): ?>未打款<?php else: ?><span style="color:red">已经打款</span><?php endif; ?></td>
                   <td style="text-align:center"><?php if($vo["type"] == '0'): ?><img src="tpl/static/adcms/img/alipay.jpg" /><?php else: ?><img src="tpl/static/adcms/img/weixin.jpg" /><?php endif; ?></td>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Adcms/tixian_ok',array('id'=>$vo['id'],'token'=>$vo['token'],'wecha_id'=>$vo['wecha_id']));?>" title="提现记录">打款成功</a>
