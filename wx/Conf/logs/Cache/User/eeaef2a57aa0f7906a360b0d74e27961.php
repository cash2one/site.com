...
<TR>
<TH valign="top" align="right" style="text-align:right">用户首次关注提示：</TH>
<TD>如果你未设置关注回复图文信息时，用户首次关注，则自动弹出关注用户的身份信息！<TD>
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">用户关怀：</TH>

  <TD><label for="radio7"><input id="radio7" class="radio" type="radio" name="guanhuai" value="1"  <?php if(($info["guanhuai"]) == "1"): ?>checked="checked"<?php endif; ?> /> 开启（首次关注弹出用户关怀信息,包括粉丝微信名称，微信头像）</label>&nbsp;&nbsp;<label for="radio8"><input class="radio" id="radio8" type="radio" name="guanhuai" value="0" <?php if(($info["guanhuai"]) == "0"): ?>checked="checked"<?php endif; ?> /> 关闭（首次关注使用关注时回复）</label></TD>

</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">用户关怀内容设置：</TH>

  <TD><input type="text" class="px" id="title" value="<?php echo ($info["title1"]); ?>" name="title1" style="width:500px" ><br>例如：恭喜来自country，province，city的sex性用户【nickname】成为我们的第total位商户，微信端显示：恭喜来自中国广东省广州市的男性用户【一起赚钱】成为我们的第200位用户<br><br>【
    "openid": "用户openid",
    "nickname": "用户微信名称",
    "sex": 用户性别,
    "province": "粉丝所在省份",
    "city": "粉丝所在城市",
    "country": "粉丝所在国籍",
    "total": 粉丝在公众号所有粉丝中的排名
】<br>此接口可用于：商家如果是卖衣服的，则可以根据用户的性别，男性则推送男性的衣服，女性则推送女性的衣服<br>如果商家是做地区代理的，则可以识别粉丝的地区，推送不同的内容</TD>

</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">用户关怀链接设置：</TH>
  
  <TD><input type="text" class="px" id="title1" value="<?php echo ($info["url"]); ?>" name="url" style="width:500px" >此处为弹出的图文链接，带http://,不设置链接请留空</TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">用户关怀标题设置：</TH>
  
  <TD><textarea  class="px" id="info" name="text" style="width:500px; height:150px"><?php echo ($info["text"]); ?></textarea><br />请不要多于1000字否则无法发送</TD>
  
</TR>
<TR>
<TH valign="top" align="right" style="text-align:right">效果图：</TH>

<TD><img  style="width: 250px;vertical-align: top;margin-left: 20px; " src="tpl/static/repaly.png"></TD>
