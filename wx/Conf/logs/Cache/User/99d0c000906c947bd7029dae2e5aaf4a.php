...
<div style="text-align:center;margin-top:20px;"><a href="<?php echo U('Home/Index/help',array('id'=>$info['id'],'token'=>$info['token']));?>" style="padding:10px 20px;font-size:16px; text-decoration:none" target="_blank" class="btnGreens">查看详细对接帮助</a>  
</div>
