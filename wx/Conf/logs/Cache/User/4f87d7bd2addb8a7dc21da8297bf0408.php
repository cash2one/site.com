	...
	<form class="form" method="post" id="form" action="" enctype="multipart/form-data">
		...
		<div class="msgWrap bgfc">
			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tbody>
                 <tr>
          <th valign="top">用户入口:</th>
          <td><span class="red"><a href="http://s.jiathis.com/qrcode.php?url=<?php echo ($info["ewmurl"]); ?>" target="_blank">http://<?php echo $_SERVER['HTTP_HOST'] ?>/index.php?g=Wap&m=Hongbaoqiye&a=index&token=<?php echo ($token); ?></a></span></td>
        </tr>
                  <tr>

						<th><span class="red">*</span>是否必须关注：</th>

						

						<td>
							<input class="radio" type="radio" name="state_subscribe" value="0"  <?php if($info['state_subscribe'] == '0'): ?>checked=""<?php endif; ?> > 是 <input class="radio" <?php if($info['state_subscribe'] == '1'): ?>checked=""<?php endif; ?> type="radio" name="state_subscribe" value="1"> 否<div style="color:red"> 					</td>
                    ...
                    <tr>
						...
						<th><span class="red">*</span>是否允许分享朋友圈：</th>

						

						<td>
							<input class="radio" type="radio" name="state_pyq" value="0"  <?php if($info['state_pyq'] == '0'): ?>checked=""<?php endif; ?> > 是 <input class="radio" <?php if($info['state_pyq'] == '1'): ?>checked=""<?php endif; ?> type="radio" name="state_pyq" value="1"> 否<div style="color:red"> 					</td>
                     ...
                     <tr>
						...
						<th><span class="red">*</span>是否允许分享好友：</th>

						

						<td>
							<input class="radio" type="radio" name="state_hy" value="0"  <?php if($info['state_hy'] == '0'): ?>checked=""<?php endif; ?> > 是 <input class="radio" <?php if($info['state_hy'] == '1'): ?>checked=""<?php endif; ?> type="radio" name="state_hy" value="1"> 否<div style="color:red"> 					</td>
                      ...
                      <tr>
						...
						<th><span class="red">*</span>分享显示粉丝头像：</th>

						

						<td>
							<input class="radio" type="radio" name="state_fanspic" value="0"  <?php if($info['state_fanspic'] == '0'): ?>checked=""<?php endif; ?> > 是 <input class="radio" <?php if($info['state_fanspic'] == '1'): ?>checked=""<?php endif; ?> type="radio" name="state_fanspic" value="1"> 否<div style="color:red"> 					</td>
                     ...
                     <tr>
						...
						<th><span class="red">*</span>分享标题带上粉丝名称：</th>

						

						<td>
							<input class="radio" type="radio" name="state_fansname" value="0"  <?php if($info['state_fansname'] == '0'): ?>checked=""<?php endif; ?> > 是 <input class="radio" <?php if($info['state_fansname'] == '1'): ?>checked=""<?php endif; ?> type="radio" name="state_fansname" value="1"> 否<div style="color:red"> 					</td>
                     ...
                     <tr>
						...
						<th><span class="red">*</span>引导关注：</th>

						<td>

							<input type="text" id="adrmb" name="url" placeholder="引导关注地址" value="<?php echo ($info["url"]); ?>" class="px" style="width:400px;" />
                     ...
                     <tr>
						...
						<th><span class="red">*</span>红包描述：</th>

						<td>

							<input type="text" id="adrmb" name="desc" placeholder=" " value="<?php echo ($info["desc"]); ?>" class="px" style="width:400px;" />
                     ...
                     <tr>
						...
						<td>
							...
							<input type="text" id="adrmb" name="title" placeholder=" " value="<?php echo ($info["title"]); ?>" class="px" style="width:400px;" />
                    ...
                    <tr>
						 ...
						 <TH valign="top"><label for="pic">封面图片：</label></TH>
                      ...
                      <tr>
						 ...
						 <TH valign="top"><label for="pic">藏宝图背景图：</label></TH>

						 <TD><input type="text" class="px"  name="cbt" id="cbt" value="<?php echo ($info["cbt"]); ?>" style="width:580px;"  />  <script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="/uploads/erweima/shareimg/hongbao.jpg"  target="_blank" class="a_upload">查看模板</a><a href="#" onclick="upyunPicUpload('cbt',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="#" onclick="viewImg('cbt')">预览</a>
					...
					<tr>
						...
						<th><span class="red">*</span>活动起止时间：</th>

						<td>

						<input type="input" class="px" id="statdate" value="<?php if($info['statdate'] != ''): echo (date("Y-m-d",$info["statdate"])); endif; ?>
              " onClick="WdatePicker()" name="statdate">&nbsp;&nbsp;&nbsp;&nbsp;<input type="input" class="px" id="enddate" value="<?php if($info['enddate'] != ''): echo (date("Y-m-d",$info["enddate"])); endif; ?>
              " onClick="WdatePicker()" name="enddate">
...
<tr>
						...
						<th><span class="red">*</span>用户参与次数限制：</th>

						<td>

							每天可参与<input type="text" id="adrmb" name="ci" placeholder=" " value="<?php echo ($info["ci"]); ?>" class="px" style="width:100px;" />次,总共可参与的次数（不包括分享所获得的）<input type="text" id="adrmb" name="user_total" placeholder=" " value="<?php echo ($info["user_total"]); ?>" class="px" style="width:100px;" />
                    ...
                    <tr>
						...
						<th><span class="red">*</span>分享参加次数限制：</th>

						<td>

							每<input type="text" id="adrmb" name="haoyou" placeholder=" " value="<?php echo ($info["haoyou"]); ?>" class="px" style="width:100px;" />个好友点击，可获得<input type="text" id="adrmb" name="choujiangci" placeholder=" " value="<?php echo ($info["choujiangci"]); ?>" class="px" style="width:100px;" />次领取机会
						</td>

					</tr>
                     <tr>

						<th><span class="red">*</span>限制活动区域(省)：</th>

						<td>

							<input type="text" id="adrmb" name="quyus" placeholder="限制领取区域，如广东省、福建省" value="<?php echo ($info["quyus"]); ?>" class="px" style="width:400px;" />只限该省的用户参与，通过ip定位,多个用‘、’隔开
						</td>

					</tr>
                     <tr>

						<th><span class="red">*</span>限制活动区域(市)：</th>

						<td>

							<input type="text" id="adrmb" name="quyu" placeholder="限制领取区域，如广州市、厦门市" value="<?php echo ($info["quyu"]); ?>" class="px" style="width:400px;" />只限该市的用户参与，通过ip定位，多个用‘、’隔开
						</td>

					</tr>
                     <tr>

						<th><span class="red">*</span>限制活动区域(县)：</th>

						<td>

							<input type="text" id="adrmb" name="quyux" placeholder="限制领取区域，如白云区、海淀区、开封县" value="<?php echo ($info["quyux"]); ?>" class="px" style="width:400px;" />只限该县的用户参与，通过ip定位，多个用‘、’隔开
						</td>

					</tr>
                     <tr>

						<th><span class="red">*</span>领取间隔时间：</th>

						<td>

							<input type="text" id="adrmb" name="jiange" placeholder=" 间隔时间" value="<?php echo ($info["jiange"]); ?>" class="px" style="width:100px;" />秒
						</td>

					</tr>
  <tr>
            <th valign="top">活动规则：</th>
            <td valign="top"><textarea class="px" id="gz" name="gz" style="width: 560px; height: 120px; display: ;"><?php echo html_entity_decode(htmlspecialchars_decode($info['gz'])); ?></textarea></td>
          </tr>
           <th valign="top">随机留言语：</th>
            <td valign="top"><textarea class="px" id="gz" name="ly" style="width: 560px; height: 120px; display: ;"><?php echo html_entity_decode(htmlspecialchars_decode($info['ly'])); ?></textarea>  <p>留言语用“、”隔开，如：哇，好大的红包啊、哈哈又收到一个红包啦！</p></td>
       
         
          </tr>
           <tr>

						<th><span class="red">*</span>版权设置：</th>

						<td>

							<input type="text" id="adrmb" name="banquan" placeholder=" 版权设置" value="<?php echo ($info["banquan"]); ?>" class="px" style="width:400px;" />
						</td>
			...
			<tr>
				...
				<td>
					...
					<button type="submit" class="btnGreen">保存</button>&nbsp; <a href="<?php echo U('Nr/index',array('token'=>$token));?>" class="btnGray vm">取消</a>
