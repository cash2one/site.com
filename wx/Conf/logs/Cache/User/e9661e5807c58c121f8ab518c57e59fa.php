...
height: 80px;
padding-left: 100px;">
                        <h0 class="baseColor ng-binding" style="color: #08a1ef;font-size: 30px;
"><?php echo ($num); ?></h0>
...
height: 80px;
padding-left: 100px;">
                        <h0 class="secondaryColor"><span class="ng-binding" style="color: #68dcc7;font-size: 30px;
padding: 10px 0;"><?php echo ($sum); ?></span></h0>
                        <h2 style="font-size: 14px;
...
height: 80px;
padding-left: 100px;">
                        <h0 class="secondaryColor"><span class="ng-binding" style="color: #9ad64b;font-size: 30px;
padding: 10px 0;"><?php echo ($date_count); ?></span></h0>
                        <h2 style="font-size: 14px;
