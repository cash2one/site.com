...
<?php $__FOR_START_227691038__=1;$__FOR_END_227691038__=12;for($i=$__FOR_START_227691038__;$i < $__FOR_END_227691038__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择设备：
...
<?php $__FOR_START_1469943623__=1;$__FOR_END_1469943623__=12;for($i=$__FOR_START_1469943623__;$i < $__FOR_END_1469943623__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择页面：
