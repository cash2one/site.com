...
<div id="MsgBox" class="Panel MsgList" style="display: none; opacity: 1;">
    <?php if(is_array($temp)): $key = 0; $__LIST__ = $temp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($key % 2 );++$key; if('1' == $key) continue; ?>
            <div class="MsgItem" msg_id="<?php echo ($item["id"]); ?>">
                <div class="head" style="background-image: url(<?php echo ($item["portrait"]); ?>);"></div>
                <div class="nickname">
                    <?php echo ($item["nickname"]); ?>
                </div>
