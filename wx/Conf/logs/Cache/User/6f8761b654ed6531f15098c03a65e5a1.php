...
<div class="cLineB">
   <div class="ftip" style="margin:25px auto 5px auto;">红包被领次数：<?php echo ($count); ?> &nbsp;&nbsp;&nbsp;&nbsp;总发放金额：<?php echo ($count_money); ?>&nbsp;&nbsp;&nbsp;&nbsp;总用户数：<?php echo ($count_user); ?></div>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <THEAD>
                ...
                <TR valign="top">
                    ...
                    <TH style="text-align:center"  width="10%">领取时间</TH>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                 ...
                 <td style="text-align:center"><?php echo ($vo["province"]); ?></td>
                  <td style="text-align:center"><?php echo ($vo["city"]); ?></td>
                    <td style="text-align:center"><?php echo ($vo["ip"]); ?></td>
                 ...
                 <!-- <td><?php echo ($vo["click"]); ?></td>-->
				  ...
				  <!-- <a href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a> -->
				   ...
				   <a href="<?php echo U('Hongbaoqiye/blackuser',array('id'=>$vo['id'],'name'=>$vo['name'],'token'=>$vo['token']));?>" title="加入黑名单">加入黑名单（用户）</a>

				   <a href="<?php echo U('Hongbaoqiye/blackip',array('id'=>$vo['id'],'token'=>$vo['token'],'ip'=>$vo['ip']));?>">加入黑名单（IP）</a></td>
