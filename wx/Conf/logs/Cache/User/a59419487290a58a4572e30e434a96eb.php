...
<?php if($_SESSION['is_syn']!= 2): if($_SESSION['is_syn'] != 1): ?>温馨提示：1、本功能使用了模板消息中的"中奖结果通知"模板消息,模板消息编号为TM00695。<br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		2、开通微信支付功能的公众号在使用此功能的时候可以在"基本设置——微信模板消息"中配置对应的模板消息。<br/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		3、活动奖项未设置，手机端默认活动状态为未开启。
		<br/><?php endif; endif; ?>
	</div>
<div class="tab">
<ul>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tablelist): $mod = ($i % 2 );++$i;?><tr>
 ...
 <style type="text/css">
   ...
   #showdiv<?php echo ($tablelist["id"]); ?>{z-index:9999; display:none;position:fixed; *position:absolute; top:20%; left:50%; margin:-50px 0 0 -50px;}
