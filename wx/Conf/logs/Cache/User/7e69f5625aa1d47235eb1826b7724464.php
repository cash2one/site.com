...
<div class="cLineB">
	<h4>自定义页面列表  <span class="FAQ">自定义页面大致与新闻类似，唯一区别就是自定义页面完全通过指定的关键词（key）来进行访问。</span></h4>
...
<div class="cLineC" style="line-height: 32px;">
	<a href="<?php echo U('Web/page',array('act'=>'page_add'));?>" class="btnGrayS vm bigbtn">添加自定义页面</a>
</div>
...
<p>自定义页面完全通过指定的关键词（key）来进行访问</p>
</span></a></th>
                        <th class="norightborder">操作</th>
</tr>
</thead>
<?php if(is_array($page_list)): $i = 0; $__LIST__ = $page_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["title"]); ?></td>
<td><?php echo ($vo["key"]); ?></td>
<td class="norightborder" width="200">
	<a href="<?php echo U('Web/page',array('act'=>'page_edit','id'=>$vo['id']));?>">编辑</a>&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Web/page',array('act'=>'page_del','id'=>$vo['id']));?>" class="del_confirm">删除</a>
	</nobr>
</td>
