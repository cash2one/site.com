			...
			<table class="userinfoArea" style=" margin:0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
				<tbody>
					<tr>
						...
						<td rowspan="4" valign="top">
							<div style="margin-left:20px">
								...
								<br />
								<a href="###" onclick="upyunPicUpload('pic1',900,500,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;&nbsp;消息回复图片&nbsp;&nbsp;<span class="red">*</span>建议尺寸：900*500
							</div>
						</td>
					</tr>
					<tr>
					...
					<?php if(session('is_syn') == '2'){ ?>
						<tr hidden="hidden">
						<td colspan="2">
							<input type="radio" name="is_attention" id="is_attention0" value="0" checked>
						</td>
						</tr>
					<?php }else{ ?>
						<tr>
