...
class PayNotifyCallBack extends WxPayNotify
{
	...
	public function Queryorder($transaction_id)
	{
		...
		Log_wx::DEBUG("query:" . json_encode($result));
	...
	{
		Log_wx::DEBUG("call back:" . json_encode($data));
		$notfiyOutput = array();
		...
		if ($order_type == 'r') {
			...
			//@file_put_contents("/alidata/www/wantease/api/payment/wxpay/testbbbs.txt", "\n B:".json_encode($result['data']['order_list']), FILE_APPEND);
...
//@file_put_contents("/alidata/www/wantease/api/payment/wxpay/testbbbs.txt", "\n E:".date('Y-m-d H:i:s'), FILE_APPEND);
Log_wx::DEBUG("begin notify");
