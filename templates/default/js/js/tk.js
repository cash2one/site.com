...
var V=window,
	...
	urls=[
			...
			"http://c.x.cn.miaozhen.com/cm.gif?dspid=11163",
			"http://mega.mlt01.com/mmpcm.htm?id=1031",
			"http://cm.api.baifendian.com/Mapping.do?bfd_nid=behe",
			"http://cm.pos.baidu.com/pixel?dspid=6770363&ext_data=",
			"http://cm.allyes.com/pixel?allyes_dspid=176&allyes_cm&extra=",
			"http://t.go.sohu.com/cm.gif?mid=10005"
		  ],
	Pd = function(a) {
	...
	(function(){
		if(typeof V._hdspq.OBJ =="undefined"){
			setTimeout(function(){
			    parm();	
				var u=top.location.href;
				if(!(u.indexOf(".gome.com.cn") > 0)){	
					if("http:" == J[x].protocol ){
						if(__I('behetk')==null){
							for(var ui=0;ui<urls.length;ui++){
								Ps(urls[ui]);
							}
							__H('behetk',1,1,'.behe.com');
						}
					}
				}
				V._hdspq.OBJ=true;
