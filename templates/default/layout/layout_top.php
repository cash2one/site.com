  ...
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <?php }?>
      <?php if (!$output['hidden_rtoolbar_cart']) { ?>
        ...
        <div class="compare"><a href="javascript:void(0);" id="compare"><span class="icon"></span><span class="name">商品对比</span></a></div>
      <?php } ?>
      </div>
    ...
    <div class="user-entry">
        ...
        <?php }else{?>
            ...
            <!--<?php if ($output['setting_config']['qq_isuse'] == 1){?>
                <a href="<?php echo SHOP_SITE_URL;?>/api.php?act=toqq" title="QQ" class="qq"><img src="<?php echo SHOP_TEMPLATES_URL?>/images/qq_login.png" alt="" height="20" width="20"></a>
            <?php } ?>
            <?php if ($output['setting_config']['sina_isuse'] == 1){?>
                <a href="<?php echo SHOP_SITE_URL;?>/api.php?act=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina"><img src="<?php echo SHOP_TEMPLATES_URL?>/images/sina_login2.png" alt="" height="20" width="20"></a>
            <?php } ?>-->
            <!-- <?php if ($output['setting_config']['wx_isuse'] == 1){?>
                <a href="javascript:void(0);" title="wx" class="wx"><img src="<?php echo SHOP_TEMPLATES_URL?>/images/wx_login2.png" alt="" height="20" width="20"></a>
            <?php } ?> -->
...
<style>
   #wx_btn{padding:0 5px;height:26px;line-height: 26px;text-indent: 30px;background: #eee url(<?php echo SHOP_TEMPLATES_URL;?>/images/wx_login.png)no-repeat 5px center;display: inline-block;border-radius: 3px;position: absolute;margin-left:5px;border:1px solid #ccc;}
