...
<style type="text/css">
.head-search-bar, .head-user-menu, .public-nav-layout, .head-app,.header_log_span1,.header_log_span2{
    ...
    <form method="post" id="porder_form" name="porder_form" action="index.php?act=pointcart&op=step2">
      <div class="ncc-receipt-info">
        ...
        <div class="ncc-candidate-items">
          ...
          <?php } ?>
          <?php } else { ?>
          <div style="color:#ff5400; height:25px; padding-top:3px;">暂无收货人地址，请先点击上方 “ 【管理】 ” ，新增收货地址，再进行兑换吧！</div>
          <?php }?>
        </div>
        <!-- 已经存在的收获地址end -->
      </div>
