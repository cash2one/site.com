  ...
  <form id="form_company_info" action="index.php?act=store_joinin&op=step2" method="post" enctype="multipart/form-data" >
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>营业执照电子版：</th>
          <td id="add_business_licence_number_electronic_error">
			<input name="business_licence_number_electronic" type="file" class="w200" />
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td id="add_organization_code_electronic_error">
			<input name="organization_code_electronic" type="file" />
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
		  </td>
        </tr>
      </tbody>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td id="add_general_taxpayer_error">
		    <input name="general_taxpayer" type="file" />
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
		  </td>
        </tr>
      </tbody>
...
$(document).ready(function(){
    ...
    $('#btn_apply_company_next').on('click', function() {
        ...
        if($('#form_company_info').valid()) {
			...
			var business_licence_number_electronic_size = $("input[name='business_licence_number_electronic']")[0].files[0].size;
			//console.log(business_licence_number_electronic_size/1024/1024);
			if(business_licence_number_electronic_size/1024/1024 > 1) {
				var str = '<label for="business_licence_number_electronic" class="error">请选择上传小于1M文件</label>';
				$('#add_business_licence_number_electronic_error').append(str);
				return false;	
			}
			
			var organization_code_electronic_size = $("input[name='organization_code_electronic']")[0].files[0].size;
			if(organization_code_electronic_size/1024/1024  > 1) {
				var str = '<label for="organization_code_electronic" class="error">请选择上传小于1M文件</label>';
				$('#add_organization_code_electronic_error').append(str);
				return false;	
			}
			
			var general_taxpayer_size = $("input[name='general_taxpayer']")[0].files[0].size;
			if(general_taxpayer_size/1024/1024  > 1) {
				var str = '<label for="general_taxpayer" class="error">请选择上传小于1M文件</label>';
				$('#add_general_taxpayer_error').append(str);
				return false;	
			}
