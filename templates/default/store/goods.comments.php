...
<div id="t" class="ncs-commend-floor">
  ...
  <dl class="detail">
    ...
    <ul class="photos-thumb"><?php $image_array = explode(',', $v['geval_image']);?>
        ...
        <li><a nctype="nyroModal"  href="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['geval_frommemberid'].DS.$value;?>">
            <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['geval_frommemberid'].DS.$value;?>">
        </a></li>
        <?php } ?></ul>
    </dd>
    <?php } ?>
