        ...
        <dl class="detail">
          ...
          <dd>
            ...
            <ul class="photos-thumb">
              ...
              <li> <a nctype="nyroModal"  href="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['geval_frommemberid'].DS.$value;?>"> <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['geval_frommemberid'].DS.$value;?>"> </a> </li>
              <?php } ?>
            </ul>
            <?php }?>
          </dd>
