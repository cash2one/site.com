    ...
    <table class="ncsc-default-table order" id="texpress1">
      <tbody>
        ...
        <tr>
          ...
          <td class="bdl bdr tc"><a nc_type='eb' nc_value="<?php echo $v;?>" href="javascript:void(0);" class="ncsc-btn" e_code="<?php echo $output['express_list'][$v]['e_code'];?>"><?php echo $lang['nc_common_button_confirm'];?></a></td>
        </tr>
        <?php }?>
        <?php }?>
      </tbody>
