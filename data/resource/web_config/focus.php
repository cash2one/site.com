<?php defined('InShopNC') or exit('Access Invalid!');?>
  ...
  <ul id="fullScreenSlides" class="full-screen-slides">
          ...
          <li ap_id="<?php echo $val['ap_id'];?>" color="<?php echo $val['color'];?>" style="background: <?php echo $val['color'];?> url('<?php echo $val['pic_img'];?>') no-repeat center top">
            <a href="<?php echo $val['pic_url'];?>" target="_blank" title="<?php echo $val['pic_name'];?>">&nbsp;</a></li>
          <?php }else { ?>
          <li style="background: <?php echo $val['color'];?> url('<?php echo $val['pic_img'];?>') no-repeat center top">
            <a href="<?php echo $val['pic_url'];?>" target="_blank" title="<?php echo $val['pic_name'];?>">&nbsp;</a></li>
          <?php } ?>
          <?php } ?>
          <?php } ?>
    ...
    <ul>
          ...
          <li>
            ...
            <a ap_id="<?php echo $v['ap_id'];?>" href="<?php echo $v['pic_url'];?>" target="_blank" title="<?php echo $v['pic_name'];?>">
                <img src="<?php echo $v['pic_img'];?>" alt="<?php echo $v['pic_name'];?>"></a>
              <?php } ?>
              <?php }else { ?>
              <?php foreach($val['pic_list'] as $k => $v) { ?>
