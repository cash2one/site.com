...
class connect_wxControl extends apiMemberControl{
...
//            }
//            $model_member->editMember(array('member_id'=> $this->member_info['member_id']),$member);
    ...
    public function get_infoOp(){
        ...
        if(!empty($code)) {
            ...
            if(!empty($user_info['unionid'])) {
                ...
                if(!empty($this->member_info['member_id'])) {//已登录时绑定微信
