...
$(function () {
    ...
    $.ajax({
        ...
        success: function (t) {
            ...
            $("#to_store").attr("href", WapSiteUrl +'/tmpl/store_intro.html?store_id=' + getQueryString("store_id"));
            $("#to_store").css("color","#fff");
            ...
            if (e.store_info.store_slide.length > 0) {
    ...
    $("#goods_rank_tab").find("a").click(function () {//店铺排行榜
        ...
        $.ajax({
            ...
            data: {store_id: e, ordertype: o, num: s},
            dataType: "json",
            success: function (e) {
                //console.log(e.datas);
                if (e.code == 200) {
